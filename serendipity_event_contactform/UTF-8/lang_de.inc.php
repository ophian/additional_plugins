...
@define('PLUGIN_CONTACTFORM_DYNAMICFIELDS_DESC', 'Dies ist die Zeichenkette, die festlegt, welche Felder im Formular angezeigt werden, ob sie erforderlich sind und was die Standardwerte sind. Wechseln Sie eine bereits selbsterstellte Vorlage (mit Speichern) und wieder zurück, steht in diesem Feld einer der default Vorlagen Zeichenketten. Das kann irritierend sein, wenn ihre selbsterstellte Zeichenkette nur geringfügig anders als die Voreinstellung ist, so dass man es nicht gleich bemerkt.');
