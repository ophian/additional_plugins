...
@define('PLUGIN_ENTRYSPLIT_CHAR_DESC',		'Jaká sekvence znakù je pou¾ita pro oznaèení konce stránky? Tuto sekvenci je tøeba zadat do pøíspìvku na místo, kde má být zalomení stránky. Pokud je tato volba prázdná, dìlení je provedeno na základì délky textu.');
