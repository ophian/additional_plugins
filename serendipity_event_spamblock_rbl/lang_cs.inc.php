...
@define('PLUGIN_EVENT_SPAMBLOCK_RBLLIST', 'Kterı RBL server má bıt kontaktován?');
@define('PLUGIN_EVENT_SPAMBLOCK_RBLLIST_DESC', 'Blokuje komentáøe v závislosti na poskytnutıch RBL seznamech. Vyhnìte se seznamùm s dynamickımi hosty.');
...
@define('PLUGIN_EVENT_SPAMBLOCK_HONEYPOT_DESC', 'Odmítne komentáøe zadané z adres vyjmenovanıch v blacklistu projektu Honeypot http:BL');
