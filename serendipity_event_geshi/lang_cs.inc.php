...
@define('PLUGIN_EVENT_GESHI_DESC',		'Barevné zvýrazòování syntaxe poèítaèových jazykù. Použití tagù: [geshi lang=nazev_jazyku [,ln={y|n}]]programový kód[/geshi]');
@define('PLUGIN_EVENT_GESHI_TRANSFORM',		'Pro vložení zdrojového kódu mùžete použít tag <b>[geshi lang=nazev_jazyku [,ln={y|n}]] [/geshi]</b>');
