...
@define('SERENDIPITY_PLUGIN_HEAVYROTATION_CONFIG_SIDEBARTITLE_DESCRIPTION', 'Der Titel der in der Seitenleiste angezeigt wird');
@define('SERENDIPITY_PLUGIN_HEAVYROTATION_CONFIG_AMAZONID_TITLE', 'Amazon API-Schlüssel');
@define('SERENDIPITY_PLUGIN_HEAVYROTATION_CONFIG_AMAZONID_DESCRIPTION', 'Dein Amazon API-Schlüssel');
@define('SERENDIPITY_PLUGIN_HEAVYROTATION_CONFIG_AMAZONCC_TITLE', 'Amazon Ländercode');
