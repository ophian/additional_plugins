...
@define('PLUGIN_EVENT_TEXTILE_TRANSFORM', '<a href="%s" target="_blank">Textile</a>-formatting allowed');
...
@define('PLUGIN_EVENT_TEXTILE_DOCTYPE', 'Textile: Convert to HTML5 (lib3/lib4 only - needs a HTML5 theme)');
@define('PLUGIN_EVENT_TEXTILE_DOCTYPE_DESC', 'Currently, PHP-Textile can target either XHTML or HTML5 output with XHTML being the default for backward compatibility. In HTML5 mode (recommended!), apart from single tag closing, you\'ll get abbr instead of acronym and if you use alignment markers on your images you\'ll have extra classes placed on them instead of XHTML\'s align attribute.');
// todo: future 
