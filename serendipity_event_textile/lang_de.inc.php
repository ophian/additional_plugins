...
@define('PLUGIN_EVENT_TEXTILE_TRANSFORM', '<a href="%s" target="_blank">Textile</a>-Formatierung erlaubt');
...
@define('PLUGIN_EVENT_TEXTILE_DOCTYPE', 'Textile: Konvertiere nach HTML5 (nur mit lib3/lib4 - benötigt ein HTML5 Template)');
@define('PLUGIN_EVENT_TEXTILE_DOCTYPE_DESC', 'Momentan kann PHP-Textile entweder XHTML (default) oder HTML5 Quellcode produzieren. Im HTML5 Modus (empfohlen!) werden, außer den single-tag Endungen, nur kleinere Änderungen, wie acronym zu abbr und align Attribute in Images zu Klassen vorgenommen.');
// todo: future 
