...
@define('PLUGIN_MICROFORMATS_TITLE_D', 'Anzeige kommender Termine in der Seitenleiste, ausgezeichnet mit dem hCalendar-Microformat');

@define('PLUGIN_MICROFORMATS_DISPLAY_N', 'Überschrift in der Seitenleiste');
@define('PLUGIN_MICROFORMATS_DISPLAY_D', 'Der hier eingegebene Text wird als Überschrift in der Seitenleiste des Blogs angezeigt');
...
@define('PLUGIN_MICROFORMATS_ENTRIES_N', 'Termine aus den Blogeinträgen berücksichtigen');
@define('PLUGIN_MICROFORMATS_ENTRIES_D', 'Termine, die in den Blogeinträgen mit dem hCalendar-Microformat ausgezeichnet sind, können ebenfalls in der Seitenleiste angezeigt werden.');
...
@define('PLUGIN_MICROFORMATS_EVENTLIST_XML_D', 'Bitte XML-Format beachten (siehe unten). Mindestens "summary" und "dtstart" müssen definiert sein.');
...
@define('PLUGIN_EVENT_MICROFORMATS_PATH_N', 'Pfad zu den Scripts');
@define('PLUGIN_EVENT_MICROFORMATS_PATH_D', 'Geben Sie den vollen HTTP-Pfad an (alles nach dem Domain-Namen), der zu diesem Plugin-Verzeichnis führt (Beispiel: /serendipity/plugins/serendipity_event_microformats).');
