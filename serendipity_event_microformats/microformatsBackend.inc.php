            ...
            <fieldset id="edit_entry_microformats" class="entryproperties_microformats">
                <span class="wrap_legend"><a name="microformatsAnchor"></a><legend><?php echo PLUGIN_EVENT_MICROFORMATS_TITLE; ?></legend></span>
                <div class="form_field">
                    <label for="hReview_use">hReview</label>
                    ...
                    <button class="toggle_info button_link" type="button" data-href="#microformats_tab_info"><span class="icon-info-circled" aria-hidden="true"></span><span class="visuallyhidden"><?php echo MORE ?></span></button>
                    ...
                    <!--<input type="hidden" name="serendipity[properties][mf_type]" id="mf_type" value="hReview" />-->
                        ...
                        ?>
                            ...
                            <div class="field">
                                ...
                                <a href="#" onclick="document.getElementById('hReview_date').value = '<?php echo date(DATE_FORMAT_2, serendipity_serverOffsetHour(time()))?>'; return false;" title="<?php echo RESET_DATE_DESC?>"><?php echo $clock ?></a>
                            </div>
                        ...
                        <fieldset>
                            <div class="field">
                             ...
                             <div class="field">
                                ...
                                <a href="#" onclick="document.getElementById('hCalendar_startdate').value = '<?php echo date(DATE_FORMAT_2, serendipity_serverOffsetHour(time()))?>'; return false;" title="<?php echo RESET_DATE_DESC?>" style="display:inline;"><?php echo $clock ?></a>
                                <br style="clear:both"/>
                                ...
                                <a href="#" onclick="document.getElementById('hCalendar_enddate').value = '<?php echo date(DATE_FORMAT_2, serendipity_serverOffsetHour(time()))?>'; return false;" title="<?php echo RESET_DATE_DESC?>" style="display:inline;"><?php echo $clock ?></a>
                                <br style="clear:left"/>
                                <br/>
                            </div>
