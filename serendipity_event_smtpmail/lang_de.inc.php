...
@define('PLUGIN_EVENT_SMTPMAIL_DESC', 'Nutze einen beliebigen SMTP Server zum Versenden deiner Mails');
@define('PLUGIN_EVENT_SMTPMAIL_SMTP_SERVER', 'Adresse des SMTP Servers');
