...
@define('PLUGIN_EVENT_SMTPMAIL_AUTH', 'Metoda pøihlášení');
@define('PLUGIN_EVENT_SMTPMAIL_AUTH_DESC', '');
@define('PLUGIN_EVENT_SMTPMAIL_SECURE', 'Použít zabezpeèené pøipojení');
@define('PLUGIN_EVENT_SMTPMAIL_SECURE_DESC', 'Nìkteré SMTP servery vyžadují pøipojení zabezpeèeným (šifrovaným) pøipojením.');
