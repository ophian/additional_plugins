...
@define('PLUGIN_EVENT_TEMPLATE_EDITOR_PATH_DESC', 'If a path is entered it is no longer determined dynamically, improving performance considerable. Example: http://www.example.com/plugins/serendipity_event_template_editor/ (note the / at the end).');
