...
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PUB_DESC', 'Zadejte veřejnou (public) část klíče pro komunikaci se serveren reCAPTCHA. O vygenerování páru klíče (veřejný + soukromý klíč) můžete požádat na https://www.google.com/recaptcha/admin');

@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV', 'Soukromý klíč recaptcha');
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV_DESC', 'Zadejte soukromou (private) část klíče pro komunikaci se serveren reCAPTCHA. O vygenerování páru klíče (veřejný + soukromý klíč) můžete požádat na https://www.google.com/recaptcha/admin');
...
@define('PLUGIN_EVENT_RECAPTCHA_INFO1', 'Recaptcha je zvláštní druh <a href="http://en.wikipedia.com/wiki/Captcha">kryptogramu</a>. Uživatel musí rozpoznat dvě slova. První systémem výzva-odpověď (ochrana před spamem), a druhé, které pomáhá při digitalizaci knih. Navíc zrakově postižení lidé mohou použít audio-kryptogram. Pro více informací se podívejte na stránku <a href="https://www.google.com/recaptcha/">www.google.com/recaptcha/</a>.<br/>Pamatujte, že abyste mohli používat tento plugin, musíte se registrovat na zmíněné webové stránce.O klíč můžete požádat  <a href="https://www.google.com/recaptcha/admin');
