...
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PUB_DESC', 'Öffentliches Schlüsselpar für die Kommunikation mit dem reCAPTCHA Server. Ein öffentliches/privates Schlüsselpaar kann unter https://www.google.com/recaptcha/admin angefordert werden.');

@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV', 'Geben Sie den privaten Schlüssel für Recaptcha ein');
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV_DESC', 'Privates Schlüsselpar für die Kommunikation mit derm reCAPTCHA Server. Ein öffentliches/privates Schlüsselpaar kann unter https://www.google.com/recaptcha/admin angefordert werden.');
...
@define('PLUGIN_EVENT_RECAPTCHA_INFO1', 'Ein Recaptcha ist eine spezielle Art von  <a href="http://de.wikipedia.com/wiki/Captcha">Captcha</a>. Der Benutzer muss zwei Worte erkennen: Eines um Spam zu verhindern, dass andere um die Digitalisierung von Büchern zu unterstützen. Sehbehinderte Menschen können sich auch ein akustisches Recaptcha anhören. Weitere Informationen finden Sie unter <a href="https://www.google.com/recaptcha/">www.google.com/recaptcha/</a>.<br/>Bitte beachten Sie, wenn sie Recaptcha nutzen wollen, dass Sie sich bei der genannten Webseite registrieren müssen. Einen Schlüssel können Sie <a href="https://www.google.com/recaptcha/admin');
