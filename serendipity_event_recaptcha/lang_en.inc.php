...
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PUB_DESC', 'Provide a public key pair for communicating with the reCAPTCHA site. You can request a public/private key pair at https://www.google.com/recaptcha/admin');

@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV', 'Private key for recaptcha');
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV_DESC', 'Provide a private key pair for communicating with the reCAPTCHA site. You can request a public/private key pair at https://www.google.com/recaptcha/admin');
