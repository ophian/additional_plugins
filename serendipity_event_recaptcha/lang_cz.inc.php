...
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PUB_DESC', 'Zadejte veøejnou (public) èást klíèe pro komunikaci se serveren reCAPTCHA. O vygenerování páru klíèe (veøejný + soukromý klíè) mù¾ete po¾ádat na https://www.google.com/recaptcha/admin');

@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV', 'Soukromý klíè recaptcha');
@define('PLUGIN_EVENT_RECAPTCHA_RECAPTCHA_PRIV_DESC', 'Zadejte soukromou (private) èást klíèe pro komunikaci se serveren reCAPTCHA. O vygenerování páru klíèe (veøejný + soukromý klíè) mù¾ete po¾ádat na https://www.google.com/recaptcha/admin');
