...
@define('PLUGIN_LINKLIST_MAINTAIN_CAT', 'Manage Linklist categories');
@define('PLUGIN_LINKLIST_ADD_CAT', 'Add Linklist categories');
@define('PLUGIN_LINKLIST_CAT_NAME', 'Category Name');
@define('PLUGIN_LINKLIST_PARENT_CATEGORY', 'Parent category');
@define('PLUGIN_LINKLIST_ADMINCAT', 'Administer Linklist categories');
...
@define('PLUGIN_LINKS_DIRECTXML_BLAHBLAH', 'You may enter xml data directly here or use the backend to manage links (watch sidebar after submitting change here).');
