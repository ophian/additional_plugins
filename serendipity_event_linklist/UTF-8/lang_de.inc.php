...
@define('PLUGIN_LINKLIST_LINK_EXAMPLE', 'Beispiel: https://github.com/ophian/styx/discussions oder https://ophian.github.io/book/');
...
@define('PLUGIN_LINKLIST_MAINTAIN_CAT', 'Linklist Kategorien verwalten');
@define('PLUGIN_LINKLIST_ADD_CAT', 'Kategorie hinzufügen');
@define('PLUGIN_LINKLIST_CAT_NAME', 'Name der Kategorie');
@define('PLUGIN_LINKLIST_PARENT_CATEGORY', 'Übergeordnete Kategorie');
@define('PLUGIN_LINKLIST_ADMINCAT', 'Linklist Kategorien administrieren');
...
@define('PLUGIN_LINKS_DIRECTXML_BLAHBLAH', 'Sie können XML-Daten hier direkt eingeben oder das Backend zum Verwalten von Links verwenden (siehe dann über die Seitenleiste).');
@define('PLUGIN_LINKS_LINKS', 'Linkliste');
@define('PLUGIN_LINKS_LINKS_BLAHBLAH', 'Verwenden Sie XML!! - Verwenden Sie für Verzeichnisblöcke <dir name="dir name"> und schließen Sie mit </dir>. - Verwenden Sie für Links <link name="link name" link="http://link.com/" />.');
