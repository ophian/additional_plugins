...
/**
 *  @version 3.40
 *  @file serendipity_event_guestbook.php, langfile(utf-8/de) v.3.40 - 2013-08-21 Ian
 *  @translated 
 *  @author Ian
...
@define('PLUGIN_GUESTBOOK_HELPFILE', 'Gästebuch-Hilfe');
@define('PLUGIN_GUESTBOOK_HELPFILE_BLAHBLAH', 'Neue Versionen dieses Plugins bringen möglicherweise neue Einstellungen mit sich, prüfen Sie diese von Zeit zu Zeit.<br />Lesen Sie die offizielle Readme und Changelog Dokumentation hier: ');
