...
@define('PLUGIN_GUESTBOOK_ADMIN_VIEW', 'zobrazit příspěvky');
...
@define('PLUGIN_GUESTBOOK_ADMIN_APP', 'schvalování příspěvků');
...
@define('PLUGIN_GUESTBOOK_ADMIN_ERASE', 'smazat příspěvky');
@define('PLUGIN_GUESTBOOK_ADMIN_ADD', 'přidat příspěvek');
...
@define('PLUGIN_GUESTBOOK_ADMIN_DBC_INSERT', 'DB - vložení');
