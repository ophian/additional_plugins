...
@define('PLUGIN_KARMARANKING_DESC', 'Zobrazuje celkové skóre autorù');
@define('PLUGIN_KARMARANKING_PROP_TITLE', 'Nadpis');
@define('PLUGIN_KARMARANKING_PROP_TITLE_DESC', 'Nadpis postranního bloku');
@define('PLUGIN_KARMARANKING_PROP_COUNT', 'Poèet autorù');
@define('PLUGIN_KARMARANKING_PROP_COUNT_DESC', 'Kolik autorù má být zobrazeno?');
