...
include_once $JPEG_TOOLKIT.'EXIF_Tags.php';
include_once $JPEG_TOOLKIT.'EXIF_Makernote.php';
include_once $JPEG_TOOLKIT.'PIM.php';
include_once $JPEG_TOOLKIT.'Unicode.php';
include_once $JPEG_TOOLKIT.'JPEG.php';
include_once $JPEG_TOOLKIT.'IPTC.php';
include_once $JPEG_TOOLKIT.'Photoshop_IRB.php';       // Change: as of version 1.11  - Required for TIFF with embedded IRB
include_once $JPEG_TOOLKIT.'XMP.php';                 // Change: as of version 1.11  - Required for TIFF with embedded XMP
include_once $JPEG_TOOLKIT.'pjmt_utils.php';          // Change: as of version 1.11  - Required for directory portability
