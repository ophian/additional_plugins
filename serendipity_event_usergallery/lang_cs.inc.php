...
#@define('PLUGIN_EVENT_USERGALLERY_DESC', 'Umožòuje nepøihlášeným uživatelùm prohlížet Serendipity knihovnu médií');//translate again
...
#@define('PLUGIN_EVENT_USERGALLERY_STYLE_DESC', '"Knihovna médií! umožòuje procházení po adresáøích a vyhledávání, zatímco "Stránka s náhledy" zobrazí náhledy všech obrázkù v adresáøi a obrázky otevírá v novém oknì.');//translate again
