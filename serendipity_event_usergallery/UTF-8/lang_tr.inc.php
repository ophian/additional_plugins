...
#@define('PLUGIN_EVENT_USERGALLERY_DESC', 'Anonim kullanıcı-ziyaretçilerin Serendipity Medya Galerisini görmelerine izin verir');//translate again
...
#@define('PLUGIN_EVENT_USERGALLERY_STYLE_DESC', 'Kullanmak istediğiniz galeri stilini seçin. "Medya Kütüphanesi" dizinler arasında gezinmenize ve arama yapmanıza imkan verir, "Küçükresim Sayfası" dizindeki küçükresimlerin gösterilmesini sağlar ve tıklandığında resimler yeni bir pencerede açılır');//translate again
