...
@define('PLUGIN_SIDEBAR_HIDER_STYLE_SIDEBAR_DESC', 'Extra style tags to apply to the Sidebar Item when the Sidebar is hidden (i.e. removing bottom padding).');
@define('PLUGIN_SIDEBAR_HIDER_STYLE_TITLE', 'Hidden Title Style');
@define('PLUGIN_SIDEBAR_HIDER_STYLE_TITLE_DESC', 'Extra style tags to apply to the Sidebar Title when the Sidebar is hidden (i.e. removing bottom borders).');
@define('PLUGIN_SIDEBAR_HIDER_STYLE_LINK', 'Hider Link Style');
...
@define('PLUGIN_SIDEBAR_HIDER_LINK_VISIBLE_DESC', 'HTML of the Sidebar Hider Link when the Sidebar is visible. (i.e. image)');
@define('PLUGIN_SIDEBAR_HIDER_LINK_HIDDEN', 'Hidden Link HTML');   
@define('PLUGIN_SIDEBAR_HIDER_LINK_HIDDEN_DESC', 'HTML of the Sidebar Hider Link when the Sidebar is hidden. (i.e. image)');
...
@define('PLUGIN_SIDEBAR_HIDER_CONF_MYSELF', 'Myself only:');
@define('PLUGIN_SIDEBAR_HIDER_CONF_CATEGORIES', 'Only categories:');
@define('PLUGIN_SIDEBAR_HIDER_FRONTPAGE_DESC', 'Frontpage');
