...
@define('PLUGIN_SIDEBAR_HIDER_STYLE_TITLE_DESC', 'Extra tagy stylù, které se mají pou¾ít na nadpis postranního sloupce, pokud je sloupec schovaný (napø. odstranìní spodního okraje).');
@define('PLUGIN_SIDEBAR_HIDER_STYLE_LINK', 'Styl odkazu "Schovat"');
@define('PLUGIN_SIDEBAR_HIDER_STYLE_LINK_DESC', 'Tag stylu, který se pou¾ije na odkaz "Schovat".');
