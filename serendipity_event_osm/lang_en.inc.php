...
@define('PLUGIN_EVENT_STATIC_OSM_COMPRESS_GPX_DESC', 'Remove not needed information from GPX-files when uploading');
...
@define('PLUGIN_EVENT_OSM_PATH_DESC', 'Path(s) for GPX-files, separated by linebreak');
