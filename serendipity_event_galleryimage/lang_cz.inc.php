...
@define('PLUGIN_EVENT_GALLERYIMAGE_ALBUM_BASE_BLAHBLAH', 'URL adresa alba pro tag <img>. (Pro verzi Gallery 2.x je tato volba pou¾ívána pro správné nastavení velikosti obrázku!)');
...
@define('PLUGIN_EVENT_GALLERYIMAGE_VERSION', 'Kterou verzi aplikace Gallery pou¾íváte?');

@define('PLUGIN_EVENT_GALLERYIMAGE_ALBUM_MAXTHUMBSIZE', 'Maximální rozmìry pro náhledy (pouze pokud pou¾íváte Gallery verze 2.x!)');
