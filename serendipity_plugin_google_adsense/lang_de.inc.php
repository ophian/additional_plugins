...
@define('PLUGIN_ADSENSE_TYPE_DESCRIPTION', 'Text- oder Bildwerbung?');

@define('PLUGIN_ADSENSE_TYPE_TEXT_AND_IMAGES', 'Text- und Bildwerbung');
@define('PLUGIN_ADSENSE_TYPE_TEXT_ONLY', 'nur Textwerbung');
