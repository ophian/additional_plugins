...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TITLE',                    'Rozšíøená tlaèítka pro ne-WYSIWYG editor');
@define('PLUGIN_EVENT_TYPESETBUTTONS_DESC',                     'Pøidá tlaèítka pro vložení kódù rùzných html entit (èárky, teèky, uvozovky) + další akce.');
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_STRIKE_BUTTON',     'Povol zobrazit tlaèítko "Pøeškrtnutí"');
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TYPE_DQUOTES_NOTE',        "Dvojitých uvozovek mùže být nìkolikero druhù:<br />
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TYPE_SQUOTES_NOTE',        "Jednoduchých uvozovek mùže být nìkolikero druhù:<br />
<div style=\"margin: auto;\">
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_REAL_APOS',                'Použít skuteèný apostrof (pokud není vybráno, tlaèítko vloží "pravou jednoduchou uvozovku")');
@define('PLUGIN_EVENT_TYPESETBUTTONS_USED_NAMED_ENTS',          'Použít pojmenované entity, kde to jen jde. Pojmenované entity mohou rozhodit nìkteré typy xml výstupù.');

@define('PLUGIN_EVENT_TYPESETBUTTONS_CUSTOM',                   'Volitelné HTML tagy');
@define('PLUGIN_EVENT_TYPESETBUTTONS_CUSTOM_DESC',              'Tady mùžete zadat seznam libovolných HTML tagù, které chcete pøidat do lišty se speciálními tlaèítky. Formát je: Nadpis@<otevírací tag>@<uzavírací tag>. Rùzné tagy jsou oddìleny znakem | (roura - pipe). Pøíklad: MojeCitace@<div class="MojeCitace">@</div>|Vystraha@<script type="text/javascript">alert(\'@\');</script>. Pokud nepotøebujete uzavírací tag, nechte jeho místo jednoduše nevyplnìné. Pøíklad: MùjObrázek@<img src="blabla.gif">@');
