...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TITLE',                    'Roz¹íøená tlaèítka pro ne-WYSIWYG editor');
@define('PLUGIN_EVENT_TYPESETBUTTONS_DESC',                     'Pøidá tlaèítka pro vlo¾ení kódù rùzných html entit (èárky, teèky, uvozovky) + dal¹í akce.');
@define('PLUGIN_EVENT_TYPESETBUTTONS_SPACE_BUTTON',             'Mez');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_SPACE_BUTTON',      'Povol zobrazit tlaèítko "Nedìlitelná mezera".');
@define('PLUGIN_EVENT_TYPESETBUTTONS_AMP_BUTTON',               '&');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_AMP_BUTTON',        'Povol zobrazit tlaèítko "Ampersand" ');
@define('PLUGIN_EVENT_TYPESETBUTTONS_EMDASH_BUTTON',            '&mdash;');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_EMDASH_BUTTON',     'Povol zobrazit tlaèítko "em pomlèka" ');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENDASH_BUTTON',            '&ndash;');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_ENDASH_BUTTON',     'Povol zobrazit tlaèítko "en pomlèka"');
@define('PLUGIN_EVENT_TYPESETBUTTONS_BULLET_BUTTON',            '&bull;');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_BULLET_BUTTON',     'Povol zobrazit tlaèítko "Teèka"');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_DQUOTES_BUTTON',    'Povol zobrazit tlaèítko "Dvojité uvozovky"');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_SQUOTES_BUTTON',    'Povol zobrazit tlaèítko "Jednoduché uvozovky"');
@define('PLUGIN_EVENT_TYPESETBUTTONS_APOS_BUTTON',              '&apos;');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_APOS_BUTTON',       'Povol zobrazit tlaèítko "Apostrof"');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ACCENT_BUTTON',            '&nbsp;&#x0301;');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_ACCENT_BUTTON',     'Povol zobrazit tlaèítko "Akcent" (èárka)');
@define('PLUGIN_EVENT_TYPESETBUTTONS_GACCENT_BUTTON',           '&nbsp;&#x0300;');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_GACCENT_BUTTON',    'Povol zobrazit tlaèítko "Grave" (obrácený akcent)');
@define('PLUGIN_EVENT_TYPESETBUTTONS_STRIKE_BUTTON',            '©krt');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_STRIKE_BUTTON',     'Povol zobrazit tlaèítko "Pøe¹krtnutí"');
@define('PLUGIN_EVENT_TYPESETBUTTONS_CENTER_BUTTON',            'Centrovat');
@define('PLUGIN_EVENT_TYPESETBUTTONS_ENABLE_CENTER_BUTTON',     'Povol zobrazit tlaèítko "Vycentrovat"');
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TYPE_DQUOTES_NOTE',        "Dvojitých uvozovek mù¾e být nìkolikero druhù:<br />
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TYPE_DQUOTES_BUTTON',      'Vyber typ dvojitých uvozovek, který se má pou¾ít');
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TYPE_SQUOTES_NOTE',        "Jednoduchých uvozovek mù¾e být nìkolikero druhù:<br />
<div style=\"margin: auto;\">
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_TYPE_SQUOTES_BUTTON',      'Vyber typ jednoduchých uvozovek, který se má pou¾ít');
...
@define('PLUGIN_EVENT_TYPESETBUTTONS_REAL_APOS',                'Pou¾ít skuteèný apostrof (pokud není vybráno, tlaèítko vlo¾í "pravou jednoduchou uvozovku")');
@define('PLUGIN_EVENT_TYPESETBUTTONS_USED_NAMED_ENTS',          'Pou¾ít pojmenované entity, kde to jen jde. Pojmenované entity mohou rozhodit nìkteré typy xml výstupù.');

@define('PLUGIN_EVENT_TYPESETBUTTONS_CUSTOM',                   'Volitelné HTML tagy');
@define('PLUGIN_EVENT_TYPESETBUTTONS_CUSTOM_DESC',              'Tady mù¾ete zadat seznam libovolných HTML tagù, které chcete pøidat do li¹ty se speciálními tlaèítky. Formát je: Nadpis@<otevírací tag>@<uzavírací tag>. Rùzné tagy jsou oddìleny znakem | (roura - pipe). Pøíklad: MojeCitace@<div class="MojeCitace">@</div>|Vystraha@<script type="text/javascript">alert(\'@\');</script>. Pokud nepotøebujete uzavírací tag, nechte jeho místo jednodu¹e nevyplnìné. Pøíklad: MùjObrázek@<img src="blabla.gif">@');
