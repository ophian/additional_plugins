...
@define('PLUGIN_EVENT_IMAGESELECTORPLUS_TARGET_BLANK', 'ポップアップウィンドウ (via target=_blank)');
@define('PLUGIN_EVENT_IMAGESELECTORPLUS_QUICKBLOG', 'クイックブログ');
@define('PLUGIN_EVENT_IMAGESELECTORPLUS_QUICKBLOG_DESC', '次の項目に少なくとも 1 つの題名を入力すれば、画像は新規ウェブログエントリとして直接投稿されるでしょう。デザインはファイル「quickblog.tpl」を用いて編集できます。');
