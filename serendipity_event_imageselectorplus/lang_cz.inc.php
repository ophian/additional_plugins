...
@define('PLUGIN_EVENT_IMAGESELECTORPLUS_DESC', 'Roz¹iøuje mo¾nosti vkládání obrázkù z knihovny médií - quickblog a hromadné vkládání obrázkù (více v dokumentaci v adresáøi plugins/serendipity_evnets_imageselectorplus).');
...
@define('PLUGIN_EVENT_IMAGESELECTORPLUS_AUTORESIZE_DESC', 'Automaticky posílá klientovi obrázky s upravenou velikostí v závislosti na hodnotách atributí width a/nebo height v tagu IMG. Toto Vám mù¾e trochu usnadnit ¾ivot a sní¾ dobu stahování stránek, ale také to sni¾uje výkon serveru. (Poznámka: pomìr stran zùstává zachován). An old feature of S9y history and at the latest with Styx 3 partly unusable, since with the new image Variations much has become irrelevant in this context. Recommended: No!');
