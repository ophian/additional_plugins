...
@define('FAQ_NEWCATEGORY', 'Neue Kategorie');
@define('FAQ_DAYSUPDATE', 'Tage der Aktualisierung');
@define('FAQ_DAYSUPDATE_DESC', 'Wieviele Tage soll ein Eintrag als aktualisiert gekennzeichnet werden?');
@define('FAQ_DAYSNEW', 'Tage als neuer Artikel');
@define('FAQ_DAYSNEW_DESC', 'Wieviele Tage soll ein Eintrag als neu gekennzeichnet werden?');
@define('FAQ_NEW', 'Neu');
