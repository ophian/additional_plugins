...
@define('PLUGIN_EVENT_COMMUNITYRATING_DESC', 'Mùžete hodnotit výrobky, filmy nebo cokoliv jiného a zobrazovat jejich hodnocení v pøíslušných pøíspìvcích. Také umožòuje sdíle hodnocení s ostatními uživateli tohoto pluginu. Tento plugin vyžaduje zásah do šablon, pøeètìte si prosím soubor README.');
