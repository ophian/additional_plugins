...
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_ANSWER_RETRIEVAL_DESC', 'Vyberte si, jak se má získat správná odpověď na kryptogram. Pokud vyberete "JSON", pak se budou posílat Ajaxové požadavky na index.php/plugin/spamblockbeecaptcha. "Smarty" poskytne odpověď pomocí proměnné Smarty {$beeCaptchaAnswer}, zatímco "Výchozí" ji natvrdo vepíše do stránky.');
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_ANSWER_RETRIEVAL_DESC_ADD', 'POZNÁMKA: Pokud je vybráno "Smarty", nebude do stránky vloženo žádné další CSS nebo JavaScript. Musíte se sami postarat o správné vyplnění políčka a jeho skrytí. "Smarty + šifrování" je v principu stejné nastavení jako "Smarty" s tím rozdílem, že odpověď uložená v {$beeCaptchaAnswer} je zašifrovaná jednoduchou XOR šifrou. Proměnná {$beeCaptchaScrambleKey} obsahuje dešifrovací klíč.');
...
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_USE_REGEXP_DESC', 'Mají se odpovědi vyhodnocovat jako regulární výrazy (PCRE = Perl compatible regular expressions)? Tato metoda může být použita pro zadání více správných odpovědí k jedné otázce. Každá řádka s odpovědí by měla být ve tvaru /pattern/:answer.');
