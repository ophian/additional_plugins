        ...
        if (isset($hooks[$event])) {
            ...
            switch($event) {
                ...
                case 'frontend_footer':
                    ...
                    if ((isset($eventData['GET']['id']) && $serendipity['view'] == 'entry' && in_array($type, ['all', 'entry'])) || ($contactFormInstalled && $serendipity['view'] == 'plugin' && $serendipity['viewtype'] == '404_4' && in_array($type, ['all', 'ctfrm']))) {
                        $this->printJsExtras();
                    }
                    break;
