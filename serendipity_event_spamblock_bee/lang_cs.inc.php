...
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_ANSWER_RETRIEVAL_DESC', 'Vyberte si, jak se má získat správná odpovìï na kryptogram. Pokud vyberete "JSON", pak se budou posílat Ajaxové požadavky na index.php/plugin/spamblockbeecaptcha. "Smarty" poskytne odpovìï pomocí promìnné Smarty {$beeCaptchaAnswer}, zatímco "Výchozí" ji natvrdo vepíše do stránky.');
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_ANSWER_RETRIEVAL_DESC_ADD', 'POZNÁMKA: Pokud je vybráno "Smarty", nebude do stránky vloženo žádné další CSS nebo JavaScript. Musíte se sami postarat o správné vyplnìní políèka a jeho skrytí. "Smarty + šifrování" je v principu stejné nastavení jako "Smarty" s tím rozdílem, že odpovìï uložená v {$beeCaptchaAnswer} je zašifrovaná jednoduchou XOR šifrou. Promìnná {$beeCaptchaScrambleKey} obsahuje dešifrovací klíè.');
...
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_USE_REGEXP_DESC', 'Mají se odpovìdi vyhodnocovat jako regulární výrazy (PCRE = Perl compatible regular expressions)? Tato metoda mùže být použita pro zadání více správných odpovìdí k jedné otázce. Každá øádka s odpovìdí by mìla být ve tvaru /pattern/:answer.');
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_USE_REGEXP_DESC_ADD', 'POZNÁMKA: Povolte tuto možnost, jen pokud opravdu víte, co dìláte. Vyplnìní špatného regulárního výrazu má za následek selhání kontroly odpovìdi a v nìkterých øídkých pøípadech Vás mùže i vystavit tzv. útoku Denial of Service! Odpovìdi delší než 1000 znakù budou odmítnuty, pokud je zapnuto ovìøování pomocí regulárních výrazù.');
