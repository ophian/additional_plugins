...
@define('PLUGIN_EVENT_SPAMBLOCK_BEE_CONFIG_ADV_USE_REGEXP_DESC', 'Mají se odpovìdi vyhodnocovat jako regulární výrazy (PCRE = Perl compatible regular expressions)? Tato metoda mù¾e být pou¾ita pro zadání více správných odpovìdí k jedné otázce. Ka¾dá øádka s odpovìdí by mìla být ve tvaru /pattern/:answer.');
