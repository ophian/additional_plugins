...
@define('PLUGIN_EVENT_EMOTICONCHOOSER_DESC', 'Zeigt eine Auswahlleiste bei der Erstellung eines Eintrags um Smileys einzufügen.');
@define('PLUGIN_EVENT_EMOTICONCHOOSER_COMMENTS', 'Smiley-Auswahl für Kommentare anbieten?');
