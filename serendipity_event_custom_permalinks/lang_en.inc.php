...
@define('PLUGIN_EVENT_CUSTOM_PERMALINKS_PL_DESC', 'Defines permalink for the URL. Needs the absolute HTTP path and needs to end with .htm or .html!  It can only use URL patterns which are NOT YET in use - using custom permalinks within the /archives/ structure is thus not possible. But any (virtual) other directory is. Empty is non-set permalink!');
@define('PLUGIN_EVENT_CUSTOM_PERMALINKS_ADDBUTTON', 'Use this URL for the field:');
