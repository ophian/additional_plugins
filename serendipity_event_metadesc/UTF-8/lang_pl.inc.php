...
@define('PLUGIN_METADESC_NAME', 'HTML META-Tagi');
...
@define('PLUGIN_METADESC_TAGNAMES', 'Tagi HTML dla "keywords"');
@define('PLUGIN_METADESC_TAGNAMES_DESC', 'Wprowad¼ rozdzielon± przecinkami listê tagów HTML, które maj± byæ przeszukiwane przez wyszukiwarki. Zazwyczaj informacja meta "keywords" zawiera s³owa kluczowe dla strony. Wpisz tu s³owa kluczowe dla Twojego wpisu.');
