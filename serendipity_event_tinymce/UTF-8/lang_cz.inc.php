...
@define('PLUGIN_EVENT_TINYMCE_DESC',            'Použije TiniMCE WYSIWYG editor pro psaní příspěvků. Vyžaduje Serendipity 1.6 nebo novější. Po instalaci si přečtěte instalačního průvodce v nastavení tohoto pluginu.');
