...
@define('PLUGIN_EVENT_RANDOMBLOGDESCRIPTION_DESC', 'Shows a random description in the header. (Separate database table has currently to be maintained manually)');
