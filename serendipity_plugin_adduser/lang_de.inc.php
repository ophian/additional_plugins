...
@define('PLUGIN_SIDEBAR_LOGIN_DESC', 'Wenn aktiviert, wird für unangemeldete Besucher eine Loginbox in der Seitenleiste angezeigt. Wenn diese Option deaktiviert wird, erscheint die Seitenleisten-Box nicht, und neue User können sich nur mittels des zugehörigen Event-Plugins und dessen Extra-Unterseite anmelden.');
...
@define('PLUGIN_ADDUSER_SENTMAIL_FAILED', 'Die Aktivierung durch sendMail() ist fehlgeschlagen...');
