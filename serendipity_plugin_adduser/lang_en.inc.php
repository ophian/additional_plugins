...
@define('PLUGIN_SIDEBAR_LOGIN_DESC', 'If enabled, a login box will be shown in the sidebar for un-logged-in visitors. If disabled you will need your users to register via a special page setup in the corresponding event plugin.');
...
@define('PLUGIN_ADDUSER_SENTMAIL_FAILED', 'The sendMail() activation failed...');
...
@define('PLUGIN_ADDUSER_SUCCEED', 'The account has been successfully enabled. You can now log in to the administrative panel of this blog, the link to there is contained in your activation email.');
...
@define('PLUGIN_ADDUSER_SENTMAIL_APPROVE_ADMIN', 'The account has been confirmed, the corresponding user will receive his account information.');
