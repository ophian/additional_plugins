...
@define('PLUGIN_EVENT_WORDWRAP_CHARS', 'Dziel zbyt długi ciąg tekstu po jak wielu znakach?');
@define('PLUGIN_EVENT_WORDWRAP_CHAR', 'Jaki znak dzielenia użyć? (jeśli nie wiesz, pozostaw domyślne ustawienie)');
@define('PLUGIN_EVENT_WORDWRAP_HARDBREAK', 'Wymusić dzielenie po X znakach? (uwaga! może to powodować problemy w działaniu innych wtyczek, np. Znacznika BBCode!)');
