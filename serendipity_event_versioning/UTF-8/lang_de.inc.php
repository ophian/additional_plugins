...
@define('VERSIONING_REVISION_CONTROL', 'Version #%d wurde wieder hergestellt. Überprüfen Sie die Änderungen und speichern Sie den Eintrag, wenn Sie mit den Änderungen einverstanden sind.');
@define('VERSIONING_PUBLIC', 'Versionen veröffentlichen?');
@define('VERSIONING_DATE_FORMAT', 'Datumsformat');
