<!-- Viewed by: {$customarchive_filter} example customarchive.tpl in plugin dir -->
...
{* customarchive_search<pre>{$customarchive_search|print_r}</pre> *}
...
<table id="ap_liste">
{* customarchive_props<pre>{$customarchive_props|print_r}</pre> *}
<tr>
...
{* customarchive_entries<pre>{$customarchive_entries|print_r}</pre> *}
