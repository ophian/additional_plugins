...
@define('PLUGIN_EVENT_COMMENTEDIT_DESC', 'Povoluje uživatelùm mìnit vlastní komentáøe i poté, co již byly odeslány.');
@define('PLUGIN_EVENT_COMMENTEDIT_PATH', 'Cesta k pluginu');
@define('PLUGIN_EVENT_COMMENTEDIT_PATH_DESC', 'Pokud je zde zadána cesta, není urèována dynamicky, což zvyšuje výkon blogu. Pøíklad: https://www.mujblog.cz/plugins/serendipity_event_commentedit/ (na konci musí být lomítko!).');
