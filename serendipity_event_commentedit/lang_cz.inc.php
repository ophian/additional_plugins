...
@define('PLUGIN_EVENT_COMMENTEDIT_PATH_DESC', 'Pokud je zde zadána cesta, není určována dynamicky, což zvyšuje výkon blogu. Příklad: https://www.mujblog.cz/plugins/serendipity_event_commentedit/ (na konci musí být lomítko!).');
