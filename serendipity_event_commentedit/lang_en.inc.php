...
@define('PLUGIN_EVENT_COMMENTEDIT_PATH_DESC', 'If a path is entered it is no longer determined dynamically, improving performance considerable. Example: https://www.example.com/plugins/serendipity_event_cimmentedit/ (note the / at the end).');
@define('PLUGIN_EVENT_COMMENTEDIT_TIMEOUT',  'Edit time');
