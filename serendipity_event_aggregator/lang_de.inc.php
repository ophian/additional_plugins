...
@define('PLUGIN_AGGREGATOR_EXPIRE_HASH', 'Prüfsummen entfernen');
@define('PLUGIN_AGGREGATOR_EXPIRE_HASH_BLAHBLAH', 'Prüfsummen werden verwendet, um Artikel ohne Datum wieder zu erkennen. Nach wieviel Tagen sollen die Prüfsummen aus der Datenbank entfernt werden? (90 = empfohlen, 0 = Nie).');
