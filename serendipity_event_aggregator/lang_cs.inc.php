...
@define('PLUGIN_AGGREGATOR_EXPIRE_HASH', 'Kontrolní součty pro expiraci');
@define('PLUGIN_AGGREGATOR_EXPIRE_HASH_BLAHBLAH', 'Kontrolní sumy se používají ke kontrole článků bez data na duplikáty. Po kolika dnech mají kontrolní součty vypršet? (90 = doporučená hodnota, 0 = nikdy).');
