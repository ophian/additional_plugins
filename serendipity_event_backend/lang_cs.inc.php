...
@define('PLUGIN_BACKEND_DESC', 'Poskytuje Javascriptový výstup nejnovìjších èlánkù pro jejich vložení do cizích, externích stránek. (Pøeètìte si soubor README v adresáøi pluginu!)');
