...
@define('PLUGIN_EVENT_XMLRPC_WPFAKEVERSION_DESC', 'Die XML-RPC Schnittstelle kann auf WordPress Aufrufe reagieren. Wenn sie nach der installierten Software Version gefragt wird, antwortet sie normalerweise mit "Serendipity ' . $serendipity['version'] .'". Wenn man hier eine Version einträgt, dann wird sie mit "WordPress (angegebene Version)" antworten. Einige Clients könnten auf eine minimale WordPress Version testen, eine Version wie "3.2"; eine Version wie "3.2" wäre dann okay.');
