        ...
        if (sidebar && bridgeData) {
            ...
            const updateTocMode = () => {
                ...
                requestAnimationFrame(() => {
                    ...
                    const shouldFloat = anchorTop != 0 && anchorTop <= Math.trunc(window.innerHeight * 0.4); // .5 is half of screen - so .4 ~ is when freetag section fills the page viewport bottom quarter
...
?>
                <div id="freetag_to_top_submit" class="jump_to_edit_entry_submit freetag_entry_submit">
