...
@define('PLUGIN_SOCIALBOOKMARKS_DISPLAYTHUMBS_N', 'Display thumbnails (ma.gnolia)?');
...
@define('PLUGIN_SOCIALBOOKMARKS_SPECIALFEATURES_USR_JS_TAGCLOUD', 'My tag cloud (del.icio.us)');
