...
@define('PLUGIN_EVENT_OUTDATE_TIMEOUT_EXPIRY_FIELD_DESC', 'Pokud používáte pøídavný modul "Rozšíøené vlastnosti pøíspìvkù", mùžete definovat pøídavné pole, do kterého zadáte datum, kdy pøíspìvku vyprší platnost. Datum musí mít formát RRRR-MM-DD. Tento plugin najde toto datum vypršení platnosti a nastaví pøíspìvek jako KONCEPT, takže zmizí ze zobrazení pøíspìvkù. Zde zadejte název pøídavného pole (napøíklad "DatumExpirace").');
