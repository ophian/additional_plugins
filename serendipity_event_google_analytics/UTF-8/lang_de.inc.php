...
@define('PLUGIN_EVENT_GOOGLE_ANALYTICS_TRACK_ADSENSE_DESC', 'Überwacht AdSense Anzeigen und fügt die Daten GA hinzu. Dazu muß Analytics und AdSense verbunden werden. (->https://support.google.com/adsense/bin/answer.py?hl=de&answer=92625)');
...
@define('PLUGIN_EVENT_GOOGLE_ANALYTICS_TRACK_EXTERNAL_DESC', 'Soll Google Analytics externe Links überwachen?');
