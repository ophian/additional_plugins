...
@define('PLUGIN_EVENT_MULTILINGUAL_ENTRY_RELOADED', 'Multilinguale Eintrags-Sprache &lsaquo; %s &rsaquo; erneuert');
...
@define('PLUGIN_EVENT_MULTILINGUAL_PURGE_ML_ENTRY', 'Aktivieren, um einen bestehenden mehrsprachigen Eintrag beim Absenden des Eingabeformulars zu löschen');
@define('PLUGIN_EVENT_MULTILINGUAL_PURGE_INFO_DESC', '<em>Wie Sie bereits erfahren haben, kann über diese zusätzliche Auswahl ein Blogeintrag mehrsprachig erstellt und verwaltet werden.</em>
   <p><strong><u>Zusammenfassung</u>:</strong> Schreiben Sie einen Blog Eintrag in der eigentlichen Blogsprache (Beispiel) "Deutsch" und speichern diesen wie gewohnt ab.
   Bei einem erneuten Aufruf aus der Datenbank hat das entryproperties event Plugin nun eine zusätzliche Auswahlmöglichkeit in den
   <b>Erweiterten Optionen</b> bereitgestellt, mit der Sie eine Sprachversion (zb, "Englisch") zur Bearbeitung auswählen bzw.
   ...
   <p><strong><u>Schreiben / Verändern / Vervielfachen</u>:</strong></p>
   <p>Die Backend Eintrags Liste führt weiterhin nur den originären deutschen Blogeintrag auf, markiert diesen aber mit der zusätzlichen
   ...
   <p><strong><u>Verwerfen</u>:</strong></p>
   ...
   wie besprochen und markieren/setzen Sie die Checkbox zur Löschung, bevor Sie den Blog-Eintrag wie immer erneut abspeichern. Die Kopf
   "Header success" Anzeige nach dem Speichern ist für den normalen Eintrags-Ablauf gestaltet und besagt, dass der Eintrag gespeichert wurde,
   obwohl Sie ihn ja mittels der Checkbox gelöscht haben. <strong>Lassen Sie sich davon nicht beirren.</strong></p>
   ...
   immer noch angezeigt, da Sie sich ja immer noch in der "Spanischen" Sprachkondition befinden. Ein erneutes unmittelbares Speichern würde ihn
   mit den gezeigten Daten erneut anlegen.</p>
...
@define('PLUGIN_EVENT_MULTILINGUAL_JS_LANG_CHANGE_NOTIFICATION', 'ACHTUNG: Sie haben zuvor Sprache "%s" ausgewählt.
 Bei "Standard" wird keine aktive Sprache geladen. "This is the End, my friend". Seien Sie umsichtig, denn nicht nur nach dem Umschalten
 könnte jetzt ein unbedachtes, weiteres Speichern direkt Ihren ursprünglichen Eintrag überschreiben.');
