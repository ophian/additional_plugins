...
@define('PLUGIN_EVENT_NEWSBOX_DESC', 'Seskupte pøíspìvky z jedné kategorie na výchozí stránce blogu do jednoho bloku místo obvyklého výpisu pøíspìvkù. Podporuje vnoøené bloky s novinkami.');
...
@define('PLUGIN_EVENT_NEWSBOX_NEWSCATS_DESC', 'Pokud se rozhodnete, ¾e má blok obsahovat kategorie, mù¾ete je zde vybrat. Mù¾ete vybrat více kategorií najednou. Pøíspìvky z tìchto kategorií se nebudou zobrazovat ve výpisu pøíspìvkù na výchozí stranì, nýbr¾ v tomto bloku.');
