...
@define('PLUGIN_EVENT_GRAVATAR_LONG_DESCRIPTION',   '<b><a href="http://www.gravatar.com" target="_blank" rel="noopener">Gravatar</a></b> je centrální úložiště obrázků uživatelů spřažené s emailovou adresou, ' .
        '<b><a href="http://www.peej.co.uk/projects/favatars.html" target="_blank" rel="noopener">Favatar</a></b> poskytuje favicony načtené z osobních stránek uživatele, <b><a href="http://www.pavatar.com" target="_blank" rel="noopener">Pavatar</a></b> ' .
        'jsou obrázky uložené na osobních stránkách pisatele a ' .
        '<b><a href="http://www.splitbrain.org/go/monsterid" target="_blank" rel="noopener">Monster ID</a></b>, <b><a href="http://scott.sherrillmix.com/blog/blogger/wp_identicon/" target="_blank" rel="noopener">Identicon</a></b> a <b><a href="http://www.shamusyoung.com/twentysidedtale/?p=1462" target="_blank" rel="noopener">Wavatar</a></b> avatary jsou nahrávané obrázky vytvořené jednotlivými uživateli.');
