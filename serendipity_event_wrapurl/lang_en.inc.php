...
@define('WRAPURL_HIGHT_BLAHBLAH', 'This is required to set the correct CSS height attribute for the iframe of this single page.');
@define('WRAPURL_PERMALINK', 'Permalink');
@define('WRAPURL_PAGETITLE', 'URL shorthand name (Backwards compatibility)');
@define('WRAPURL_PAGETITLE_BLAHBLAH', 'This is used for individual subpage and CSS naming. One single word is required!');
...
@define('WRAPURL_URL_APPEND', 'Append GET-Variables');
