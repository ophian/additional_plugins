...
@define('PLUGIN_ETHICS_BLAHBLAH', 'Zobrazuje uživatele s vyobrazením jejich etické úrovnì (vyjádøenou semaforem). Zelená znamená "'.PLUGIN_ETHICS_GREENLIGHT.'"; oranžová znamená "'.PLUGIN_ETHICS_YELLOWLIGHT.'"; a èervená znamená "'.PLUGIN_ETHICS_REDLIGHT.'". Administrátor mùže lehce mìnit tyto hodnoty u jednotlivých uživatelù.');
