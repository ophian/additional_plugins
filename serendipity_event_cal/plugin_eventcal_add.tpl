{* file: plugin_eventcal_add.tpl - 2023-12-08, Ian Styx *}
...
{foreach from=$plugin_eventcal_add_array_opt1 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt7 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt2 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt3 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt8 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt4 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt5 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{foreach from=$plugin_eventcal_add_array_opt6 item="i"}
{if $i}
                                        {$i}
{/if}
{/foreach}
...
{if $is_logged_in}
                                    <br><br><sup>{$CONST.CAL_EVENT_FORM_RIGHT_BBC}</sup><br>
