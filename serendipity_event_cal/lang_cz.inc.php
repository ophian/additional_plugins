...
@define('CAL_EVENT_FALSECAPTCHA', 'Kryptogram u Va¹eho pøíspìvku se neshoduje!');
...
@define('PLUGIN_EVENTCAL_ICAL_LOG', 'Pøihlá¹ení pro sta¾ení iCal?');
...
@define('PLUGIN_EVENTCAL_ICAL_LOG_EMAIL', 'Administrátorská emailová adresa (v závislosti na nastavení \'pøihlá¹ení nastavené na ano\' a/nebo \'iCal URL\')');
@define('PLUGIN_EVENTCAL_ICAL_LOG_EMAIL_BLAHBLAH', 'Va¹e emailová adresa, na kterou se budou posílat oznámení o iCa exportech.');
...
@define('PLUGIN_EVENTCAL_ICAL_ICSURL_BLAHBLAH', 'Sta¾ení, u¾ivatelský po¾adavek webcal-push, email (na administrátorskou adresu, která musí být ní¾e nastavena) nebo v¹echny tøi. V tom pøípadì si u¾ivatel vybere, který se mu hodí nejvíce.');
@define('PLUGIN_EVENTCAL_ICAL_ICSURL_INLIST_NO', '¾ádný ics soubor');
...
@define('PLUGIN_EVENTCAL_SENDMAIL_BLAHBLAH', 'iCal soubor byl úpì¹nì odeslán!');
...
@define('CAL_EVENT_FORM_RIGHT_RECURSTRICT2', 'pøísnì podle prvního dne u v¹ech opakujících se událostí!');
@define('CAL_EVENT_FORM_RIGHT_RECUR_BIWEEK', 'ka¾dý druhý týden');
@define('CAL_EVENT_FORM_RIGHT_RECUR_YEAR', 'ka¾dý rok');
@define('CAL_EVENT_FORM_RIGHT_HELP_SINGLE', 'Jednotlivá událost. \'Koneèné datum\' ani ¾ádná dal¹í informace není potøeba!');
@define('CAL_EVENT_FORM_RIGHT_HELP_MULTI', 'Multi-událost: Zobrazovat mìsíènì. Vy¾aduje \'Poèáteèní datum\' a \'Koncové datum\'.');
@define('CAL_EVENT_FORM_RIGHT_HELP_WEEK', 'Týdenní událost. Urèitì je potøeba nastavit. \'v¾dy zapnuto\', \'Týdnì\' a a \'Den v týdnu\'. Zobrazuje ka¾dý kalendáøní týden v mìsíci. Vy¾aduje \'Poèáteèní datum\' a \'koncové datum\'.');
@define('CAL_EVENT_FORM_RIGHT_HELP_BIWEEK', 'Ètrnáctidenní událost. Urèitì je tøeba zadat: \'v¾dy zapnuto\', \'Týdnì\' a \'Den v týdnu\'. Zobrazuje se ka¾dý druhý kalendáøní týden v mìsíci. Vy¾aduje \'Poèáteèní datum\' a \'Koncové datum\'.');
@define('CAL_EVENT_FORM_RIGHT_HELP_MONTH', 'Mìsíèní událost. Urèitì je tøeba zadat: \'v¾dy zapnuto\', \'ntý Den\' a \'Den v týdnu\'. Zobrazuje se ka¾dý mìsíc. Vy¾aduje \'Poèáteèní datum\' a \'Koncové datum\'.');
@define('CAL_EVENT_FORM_RIGHT_HELP_YEAR', 'Roèní událost. Zobrazuje se roènì od \'Poèáteèního data\'. Nepotøebuje \'Koncové datum\' ani ¾ádné dal¹í nastavení!');
@define('CAL_EVENT_FORM_BUTTON_HELP_ICALM', 'Sta¾ení událostí iCal ze v souèasném mìsíci vèetnì v¹ech opakujících se událostí z minulosti i budoucnosti.');
...
@define('PLUGIN_EVENTCAL_ADMIN_APP_DESC', 'Seskupit podle Poèáteèního data [nejnovìj¹í nahoøe].');
...
@define('PLUGIN_EVENTCAL_ADMIN_LOG_ERROR', 'POZOR: Pøi zapisování iCal logovacího souboru se vyskytla chyba. Zkontrolujte, co je ¹patnì (má adresáø a soubor nastavená práva pro zápis?)!');
...
@define('PLUGIN_EVENTCAL_ADMIN_NORESULT_FREE', 'vyèi¹tìní');
@define('PLUGIN_EVENTCAL_ADMIN_FREE_SURE', 'Urèitì chcete odstranit staré události z databázové tabulky událostí?');
@define('PLUGIN_EVENTCAL_ADMIN_CLEAN_SURE', 'Urèitì chcete nastavit novou hodnotu autoincrementu (id) pro v¹echna data v databázové tabulce kalendáøe událostí?');
@define('PLUGIN_EVENTCAL_ADMIN_CLEAN_SURE_ADD', '<u>Upozornìní:</u> Mù¾e to mít negativní dopady na cachovaná data ve vyhledávaèích a podobných slu¾bách mimo Vá¹ blog!');
@define('PLUGIN_EVENTCAL_ADMIN_DROP_SURE', 'Urèitì chcete smazat celou tabulku kalendáøe událostí vèetnì v¹ch dat? Potvrïte prosím zde!');
@define('PLUGIN_EVENTCAL_ADMIN_DROP_OK', 'Va¹e %s databázová tabulka byla úspa¹nì vymazána!');
@define('PLUGIN_EVENTCAL_ADMIN_DUMP_SELF', 'Pøed pokraèováním byste mìli pro jistotu udìlat mysql dump pomocí PhpMyAdmina!');
@define('PLUGIN_EVENTCAL_ADMIN_ICAL_EMAILLINK', 'Stáhnìte v¹echny schválené události jako ics soubor pomocí emailu na administrátorskou adresu, pokud je nastavená v konfiguraci tohoto pluginu! Ujistìte se, ¾e je zadaná!');
@define('PLUGIN_EVENTCAL_ADMIN_ICAL_DOWNLINK', 'Stáhnout v¹echny schválené události jako ics soubor!');
@define('PLUGIN_EVENTCAL_ADMIN_DBC_TITLE', 'Pou¾ívejte prosím tento administraèní panel opatrnì.');
@define('PLUGIN_EVENTCAL_ADMIN_DBC_TITLE_DESC', 'Nìkteré odkazy mohou být v pøí¹tích verzích vylep¹eny!');
...
@define('PLUGIN_EVENTCAL_ADMIN_DBC_DELOLD', 'Administrace - èi¹tìní');
@define('PLUGIN_EVENTCAL_ADMIN_DBC_DELOLD_DESC', 'odstranit události star¹í ne¾ 1 mìsíc z databázové tabulky kalendáøe akcí');
@define('PLUGIN_EVENTCAL_ADMIN_DBC_DELOLD_TITLE', 'smazat data star¹í ne¾ 1 mìsíc z databázové tabulky');
@define('PLUGIN_EVENTCAL_ADMIN_DBC_DELOLD_MSG', 'Z databázové tabulky jste odstranili %d starých událostí star¹ích ne¾ 30 dní.');
...
@define('PLUGIN_EVENTCAL_ADMIN_DBC_ICALALL_DESC', 'po¹lete v¹echny události jako iCal soubor administrátorovi - pomocí emailu, pokud je zadán v nastavení, jinak pomocí downloadu');
...
@define('PLUGIN_EVENTCAL_ADMIN_DBC_DUMP_DONE', 'Databáze kalendáøe akcí byla úspì¹nì zálohována!');
