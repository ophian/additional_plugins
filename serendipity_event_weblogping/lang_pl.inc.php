...
@define('PLUGIN_EVENT_WEBLOGPING_CUSTOM_BLAHBLA', 'Jeden (lub więcej) specjalistyczny serwis sieciowy (serwisy rozdzielaj przecinkiem ","). Dane powinny być wpisane w podobny do następującego sposób: "host.domena/ścieżka". Jeśli zostanie wprowadzony znak "*" na początku nazwy hosta, rozszerzony ping XML-RPC zostanie wysłany do takiego hosta (tylko jeśli host obsługuje takie pingi). You have to submit this form several times, until the new entries are placed into the upper list.');
