...
@define('PLUGIN_EVENT_WEBLOGPING_CUSTOM_BLAHBLA', '如果有自訂的通知功能可以在這輸入，用逗點 (,) 來分開每個功能。使用範例："host.domain/path"。如果主機名前面有星號 (*)，額外的 XML-RPC 資料會傳送給主機 (如果主機支援)。 You have to submit this form several times, until the new entries are placed into the upper list.');
