...
@define('PLUGIN_EVENT_WEBLOGPING_CUSTOM_BLAHBLA', 'Um ou mais serviços ping adicionais, separados por ",". As entradas precisam de ser formatadas como: "máquina.domínio/caminho". Se um "*" for introduzido no princípio do nome de uma máquina, as opções XML-RPC adicionais serão enviadas para essa máquina (se suportadas por essa máquina). You have to submit this form several times, until the new entries are placed into the upper list.');
