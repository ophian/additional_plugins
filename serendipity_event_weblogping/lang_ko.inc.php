...
@define('PLUGIN_EVENT_WEBLOGPING_CUSTOM_BLAHBLA', '","로 구분하여 한 개 이상의 특별 핑 서비스를 입력합니다. 입력 사항은 "호스트.도메인/경로" 식으로 적어야 합니다. 호스트 이름 앞에 "*"를 입력하면 확장 XML-RPC 옵션이 해당 호스트에 전송됩니다 (호스트가 지원해야 함). You have to submit this form several times, until the new entries are placed into the upper list.');
