...
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_DESC', 'Na úvodní stránce blogu zobrazuje u každého pøíspìvku zprávu o datu poslední zmìny. Pro pøíspìvky, které nikdy nebyly pozmìòovány, zobrazuje zprávu, že nikdy nebyly mìnìny.');
...
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_SHOWNOTMODIFIED_DESC', 'Pokud je povoleno, zpráva o poslední zmìnì bude zobrazena pro všechny pøíspìvky, jinak pouze pro mìnìné pøíspìvky.');
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_POSITION', 'Umístìní zprávy');
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_POSITION_DESC', 'V které èásti pøíspìvku má být zpráva o zmìnách umístìna?');
