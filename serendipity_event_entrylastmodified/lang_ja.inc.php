...
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_POSITION','メッセージの位置');
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_POSITION_DESC','');
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_LEFT', '左');
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_CENTER', '中央');
@define('PLUGIN_EVENT_ENTRYLASTMODIFIED_RIGHT', '右');
