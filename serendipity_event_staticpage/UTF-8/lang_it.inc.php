...
@define('STATICPAGE_TITLE', 'Pagina statica');
@define('STATICPAGE_TITLE_BLAHBLAH', 'Visualizza una pagina statica nel tuo blog con la stessa grafica e formattazione del blog stesso');
@define('STATICPAGE_PAGETITLE', 'Titolo del link');
