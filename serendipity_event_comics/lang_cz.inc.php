...
@define('PLUGIN_COMICS_CAT_DESC', 'Kategorie, která obsahuje komix. Komix by mìl být v hlavním tìle pøíspìvku. Vyberte "¾ádná" a komixy vypnete.');
...
@define('PLUGIN_COMICS_HIDE_DESC', 'Nezobrazovat na výchozí stránce star¹í komixy jako samostatné pøíspìvky. Toto nastavení pøepí¹e nastavení v jiných pluginech. Nejnovìj¹í komix nebude zobrazován jako samostatný pøíspìvek v ka¾dém pøípadì.');
