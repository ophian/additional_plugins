...
@define('PLUGIN_EVENT_STATISTICS_OUT_PER_AUTHOR', 'Záznamy podle u¾ivatelù');
...
@define('PLUGIN_EVENT_STATISTICS_OUT_TOPTRACKBACKS3', 'Nejèastìj¹í odezvy ètenáøù');
...
@define('PLUGIN_EVENT_STATISTICS_OUT_LONGEST_ARTICLES', '%s nejdel¹ích záznamù');
...
@define('PLUGIN_EVENT_STATISTICS_EXT_ADD', 'Roz¹íøené statistiky pro návtìvníky');
@define('PLUGIN_EVENT_STATISTICS_EXT_ADD_DESC', 'Pøidat roz¹íøené statistiky pro náv¹tìvníky stránek? (Standardnì: NE)');
...
@define('PLUGIN_EVENT_STATISTICS_EXT_ALL', 'Ukázat v¹echno?');
@define('PLUGIN_EVENT_STATISTICS_EXT_ALL_DESC', 'Zobrazit v¹echny statistiky, i o u¾ivatelích? (Standardnì: NE)');
@define('PLUGIN_EVENT_STATISTICS_EXT_ALL1', 'NE, kromì poèítadel v¹echno schovej.');
...
@define('PLUGIN_EVENT_STATISTICS_EXT_VISTODAY', 'Náv¹tìvníkù dnes');
...
@define('PLUGIN_EVENT_STATISTICS_EXT_VISTOTAL', 'Náv¹tìvníkù celkem (since %s)');
...
@define('PLUGIN_EVENT_STATISTICS_EXT_COUNTDESC', 'Zobrazení se mohou vy¹plhat do velkých hodnot, proto¾e jsou zvý¹ena pøi KA®DÉM naètení stránky. Není to èíslo poètu lidí, kteøí stránku prohlí¾eli. Je to ukazatel poètu zobrazení stránky.');
@define('PLUGIN_EVENT_STATISTICS_EXT_VISLATEST', 'Poslední náv¹tìvníci');
@define('PLUGIN_EVENT_STATISTICS_EXT_TOPREFS', 'Top odkazovaèe');
@define('PLUGIN_EVENT_STATISTICS_EXT_TOPREFS_NONE', '®ádné odkazy je¹tì nebyly zaznamenány.');
@define('PLUGIN_EVENT_STATISTICS_EXT_DAYGRAPH', 'Náv¹tìvy podle dní');
@define('PLUGIN_EVENT_STATISTICS_EXT_MONTHGRAPH', 'Náv¹tìvy podle mìsícù');
@define('PLUGIN_EVENT_STATISTICS_OUT_EXT_STATISTICS', 'Roz¹íøená statistika o u¾ivatelích');
...
@define('PLUGIN_EVENT_STATISTICS_BANNED_HOSTS_DESC', 'Nastav na \'Zapnout\' pokud do statistik nechce¹ zapoèítávat vyhledávací roboty. nastav na \'Vypnout\' a roboti budou zapoèítáni. V souèasné dobì filtruje 290 známých robotù.');
...
@define('PLUGIN_EVENT_STATISTICS_SHOW_MONTHVISITORS', 'Zobraz náv¹tìvníky v tomto mìsíci');
@define('PLUGIN_EVENT_STATISTICS_SHOW_DAYVISITORS', 'Zobraz náv¹tìvníky dnes');
@define('PLUGIN_EVENT_STATISTICS_SHOW_WEEKVISITORS', 'Zobraz náv¹tìvníky tento týden');
@define('PLUGIN_EVENT_STATISTICS_SHOW_CACHETIMEOUT', 'Cache timeout');
@define('PLUGIN_EVENT_STATISTICS_SHOW_CACHETIMEOUT_DESC', 'Jak dlouho mají být statistiky zobrazeny pøed znovunaètením? Nastavení této hodnoty na vysoký poèet minut zvìt¹í výkon, ale pokud bude hodnota pøíli¹ vysoká, mo¾ná nebude zobrazovat aktuální data.');
@define('PLUGIN_EVENT_STATISTICS_TEXT', 'Formátování text');
@define('PLUGIN_EVENT_STATISTICS_TEXT_DESC', 'Pou¾ij symbol %s pro vlo¾ení èísla/textu');
...
@define('PLUGIN_EVENT_STATISTICS_TEXT_MONTHVISITORS', '%s náv¹tìvník(ù) tento mìsíc');
@define('PLUGIN_EVENT_STATISTICS_TEXT_DAYVISITORS', '%s náv¹tìvník(ù) dnes');
@define('PLUGIN_EVENT_STATISTICS_TEXT_WEEKVISITORS', '%s náv¹tìvník(ù) tento týden');

@define('PLUGIN_EVENT_STATISTICS_SHOW_CURRENTVISITORS', 'Uka¾ poèet online náv¹tìvníkù (poèítáno bìhem posledních 15 minut)');
@define('PLUGIN_EVENT_STATISTICS_TEXT_CURRENTVISITORS', '%s náv¹tìvník(ù) online');
