...
@define('PLUGIN_EVENT_STATISTICS_EXT_VISTOTAL', 'Látogató összesen (since %s)');
...
@define('PLUGIN_EVENT_STATISTICS_EXT_HITSTOTAL', 'Látogatások összesen (since %s)');
...
@define('PLUGIN_EVENT_STATISTICS_BANNED_HOSTS_DESC', 'Állítsd \'iegn\'-re, hogy ne számoljuk az oldalakat látogató robotokat. \'Nem\' esetén számoljuk az oldalt lekérõ robotot is mint látogató. Jelenleg több mint 290 robot van tiltólistán.');
