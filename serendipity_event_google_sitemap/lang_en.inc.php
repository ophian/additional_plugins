...
@define('PLUGIN_EVENT_SITEMAP_REPORT_OK', 'Sent sitemap update to %s.<br/>');
@define('PLUGIN_EVENT_SITEMAP_REPORT_MANUAL','If you have not submitted your sitemap to %s, do it now with visiting <a href="%s">this link</a>.<br/>');
...
@define('PLUGIN_EVENT_SITEMAP_URL_DESC', 'URLs for pingbacks (%s is replaced with the sitemap-URL, separate multiple entries with \';\' (semicolon), if you need to enter a ; use \'%3B\').');
