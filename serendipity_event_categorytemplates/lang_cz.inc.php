...
#@define('PLUGIN_CATEGORYTEMPLATES_DESC', 'Tento plugin poskytuje pøídavné vlastnosti pro kategorie a v nich obsa¾ené pøíspìvky, vèetnì volitené ¹ablony vzhledu, poøadí øazení, poèet zobrazených pøíspìvkù, ochranu heslem a schovávání RSS kanálu.');// translate new, see en
@define('PLUGIN_CATEGORYTEMPLATES_SELECT', 'Zadejte prosím název adresáøe se ¹ablonou, kterou chcete pou¾ít pro tuto kategorii. Relativní cesta zaèíná v adresáøi "templates/". Tak¾e mù¾ete zadat napøíklad "blue" nebo "kubrick". Mù¾ete pou¾ít také název podadresáøe, pokud jste ulo¾ili ¹ablonu v podadresáøi jiné ¹ablony. Pak zadáváte "blue/kategorie1" nebo "blue/kategorie2". Recommended use is to add a category own "Engine:" template.');
...
@define('PLUGIN_CATEGORYTEMPLATES_CATPRECEDENCE_DESC', 'Pokud je pøíspìvek pøiøazen do více kategorií, tento seznam urèuje, která ¹ablona bude pou¾ita. ©ablona pro kategorii, která je nejvý¹e, bude pou¾ita. To be able to save and activate your order changes for existing categorytemplates, you must first activate their checkbox(es) here.');
@define('PLUGIN_CATEGORYTEMPLATES_NO_CUSTOMIZED_CATEGORIES', '®ádné kategorie je¹tì nemají vlastní ¹ablonu. In this case let this checkbox unchecked!');
