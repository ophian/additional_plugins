...
@define('PLUGIN_CATEGORYTEMPLATES_SELECT', 'Please enter the directory name of the theme you wish to use for this category. The relative directory names begin below the "templates/" structure. So you can use i.e. "blue" or "kubrick". You can also enter a subdirectory name, if you saved a subdirectory within your theme directory as if it were a theme on its own. Then you can enter i.e. "blue/category1" or "blue/category2". But the recommended use is to add a category own "Engine:" theme.<br>To change the order categories will be considered in when custom themes are applied, configure the category templates plugin.<br>Dot not forget to reset the list hide option down below, when removing a category theme assignment.');
