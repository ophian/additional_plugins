...
<div class="serendipity_entry">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr style="background-color: {$bgcolor2};">
			<td>
				<textarea style="width: 95%;" rows="12" width="95%" id="serendipity_commentform_comment" name="serendipity[comment]">{$POST_MESSAGE}</textarea><br />
                {if $commentform_entry}{serendipity_hookPlugin hook="frontend_comment" data=$commentform_entry}{/if}
			</td>
		</tr>
