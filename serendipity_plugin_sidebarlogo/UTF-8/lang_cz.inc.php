...
@define('PLUGIN_SIDEBARLOGO_SITENAME_DESC',		'Název Vaší stránky (např. Americká pobočka Škoda Auto)');
@define('PLUGIN_SIDEBARLOGO_SITETAG',		'Slogan');
@define('PLUGIN_SIDEBARLOGO_SITETAG_DESC',		'Slogan nebo motto stránky (např. Auta pro všechny)');
@define('PLUGIN_SIDEBARLOGO_IMAGE',		'Logo');
@define('PLUGIN_SIDEBARLOGO_IMAGE_DESC',		'Vyberte obrázek z mediatéky');
@define('PLUGIN_SIDEBARLOGO_IMAGEWIDTH',		'Šířka obrázku');
@define('PLUGIN_SIDEBARLOGO_IMAGEWIDTH_DESC',		'Omezte logo na šířku (ponechte prázdné pro žádné omezování, jinak např. 50px, nebo 200%)');
@define('PLUGIN_SIDEBARLOGO_IMAGEHEIGHT',		'Výška obrázku');
@define('PLUGIN_SIDEBARLOGO_IMAGEHEIGHT_DESC',		'Omezte logo na výšku (ponechte prázdné pro žádné omezování, jinak např. 50px, nebo 200%)');
@define('PLUGIN_SIDEBARLOGO_DESCRIPTION',		'Popis');
@define('PLUGIN_SIDEBARLOGO_DESCRIPTION_DESC',		'Popis účelu a cíle Vašich stránek');
...
@define('PLUGIN_SIDEBARLOGO_SEQUENCE_DESC',		'Pořadí jednotlivých prvků SideBar Logo');
