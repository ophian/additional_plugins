...
@define('PLUGIN_SIDEBARLOGO_IMAGESTYLE_DESC', 'Style to use for your logo. Start text with "#" to provide a CSS id, with a "." to provide a class or use inline styles directly.');
...
@define('PLUGIN_SIDEBARLOGO_SITENAMESTYLE_DESC', 'Style to use for your site name. Start text with "#" to provide a CSS id, with a "." to provide a class or use inline styles directly.');
...
@define('PLUGIN_SIDEBARLOGO_SITETAGSTYLE_DESC', 'Style to use for your site tag. Start text with "#" to provide a CSS id, with a "." to provide a class or use inline styles directly.');
...
@define('PLUGIN_SIDEBARLOGO_CONTACTSTYLE_DESC', 'Style to use for your contact information. Start text with "#" to provide a CSS id, with a "." to provide a class or use inline styles directly.');
...
@define('PLUGIN_SIDEBARLOGO_COPYRIGHTSTYLE_DESC', 'Style to use for your contact information. Start text with "#" to provide a CSS id, with a "." to provide a class or use inline styles directly.');
