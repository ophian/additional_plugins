...
@define('PLUGIN_SIDEBAR_IMAGESIDEBAR_DESC', 'Umo¾òuje zobrazovat obrázky v postranním sloupci. Zdrojù tìchto obrázkù mù¾e být vícero. Plugin se doká¾e pøipojit do databáze Coppermine galerie (pouze pokud bì¾í na MySQL) a samozøejmì i ke Knihovnì médií Serendipity.');
...
@define('PLUGIN_SIDEBAR_MEDIASIDEBAR_URL_DESC', 'Stálá URL adresa, na kterou má vést odkaz. (napø. "https://www.example.org/")');
