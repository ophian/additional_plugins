...
class coppermine_sidebar extends subplug_sidebar
{
...
<!--
<?php
    readfile(dirname(__FILE__) . '/coppermine_styles.css');
?>
-->
</style>
...
<?php
        ...
        $defthumbnail = $serendipity['serendipityHTTPPath'] . 'plugins/serendipity_plugin_imagesidebar/coppermine_none.jpg';
        ...
        while ($row = mysql_fetch_array($result)) {
            ...
            if (!isset($row['pwidth']) ||
                ...
                $defimage =
                    ...
                    '" alt="' .
                    $row['filename'] .
                    '" class="cm_thumbnail" style="width:' .
                    $size .
                    'px; height:' .
                    $size .
                    'px;"></a>';
                ...
                echo
                    ...
                    '" alt="' .
                    $row['filename'] .
                    '" class="cm_thumbnail" style="padding: ' .
                    $vpad .
                    'px ' .
                    $hpad .
                    'px ' .
