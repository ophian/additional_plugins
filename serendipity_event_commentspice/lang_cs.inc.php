...
@define('PLUGIN_EVENT_COMMENTSPICE_CONFIG_BOO_DESC','Pokud máte podcastovací blog, možná chcete umožnit uživatelùm vkládat i audio komentáøe, tzv. boo audios (mini podcasty) umístìné na <a href="http://audioboo.fm" target="_blank" rel="noopener">audioboo.fm</a>.');
...
@define('PLUGIN_EVENT_COMMENTSPICE_BOO_FOOTER','Tento blog Vám umožòuje vložit audio boo komentáøe pomocí <a href="http://audioboo.fm/profile" target="_blank" rel="noopener">audioboo.fm</a>. <a href="http://audioboo.fm/boos/new" target="_blank" rel="noopener">Nahrajte nový komentáø</a> a zadejte odkaz do políèka audio boo.');
