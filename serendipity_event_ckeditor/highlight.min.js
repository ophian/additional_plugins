...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
strings:i,keywords:u}}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("less",(()=>{"use strict"
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},n,r]}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
skip:!0})]}]})})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
end:/$/}]})})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:p}}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
contains:[a.SHEBANG({binary:"ruby"})].concat(E).concat(c).concat(_)}}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
contains:[c]}]}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
starts:{end:/$/,contains:[t,l,r,i,c,a]}}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
name:"TypeScript",aliases:["ts","tsx"]}),m}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
;var n})).join("|")+")"}return n=>{
