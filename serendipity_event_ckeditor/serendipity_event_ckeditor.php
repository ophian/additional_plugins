...
class serendipity_event_ckeditor extends serendipity_event
{
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.20.0.0'); // is CKEDITOR Series 4.20.0 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.20.0.0', '4.19.1.1'); // was temporary used for the harmonization of plugin and lib versions
