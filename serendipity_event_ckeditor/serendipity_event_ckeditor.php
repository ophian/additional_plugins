...
class serendipity_event_ckeditor extends serendipity_event
{
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.10.0.3'); // is CKEDITOR Series 4.10.0 - and appended plugin revision .3
    ...
    {
        #$this->temporaryDowngrade('4.10.0.3', '4.10.0.2'); // was temporary used for the harmonization of plugin and lib versions
