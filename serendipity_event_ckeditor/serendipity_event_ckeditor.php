...
class serendipity_event_ckeditor extends serendipity_event
{
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.10.0.0'); // is CKEDITOR Series 4.10.0 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.10.0.0', '4.9.2.0'); // was temporary used for the harmonization of plugin and lib versions
