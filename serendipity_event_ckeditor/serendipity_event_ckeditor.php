...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.15.0.0-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.15.0.0');
     ...
     * @var array
     */
    protected $revisionPackage = array('CKEditor 4.15.0 (revision cc4885b53, full package, 2020-09-07)',
                                       'CKEditor-Plugin: mediaembed, included to custom build. v. 0.6 (https://github.com/frozeman/MediaEmbed, 2013-07-11)',
                                       'CKEditor-Plugin: Custom build added for current version "ajax", "autocomplete", "autogrow", "autolink", "button", "clipboard", "dialog", "dialogui", "embedbase", "emoji", "fakeobjects", "floatpanel", "lineutils", "notification", "notificationaggregator", "panelbutton", "placeholder", "textmatch", "textwatcher", "undo", "widget", "widgetselection" and "xml" plugins, 2020-09-07)',
                                       'CKEditor-Plugin: Manually added for current version ""codesnippet", "embed" and "embedsemantic" plugins, 2020-10-06)',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.15.0.0'); // is CKEDITOR Series 4.15.0 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.15.0.0', '4.14.1.8'); // was temporary used for the harmonization of plugin and lib versions
