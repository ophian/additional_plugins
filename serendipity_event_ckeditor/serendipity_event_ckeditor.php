...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.18.0.1-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.18.0.1');
    ...
    protected $revisionPackage = array('CKEditor 4.18.0 (revision 5fe059002f3, full package, 2022-03-16)',
                                       ...
                                       'CKEditor-S9yAddOn, fresh highlight.min.js file v.11.3.1 (https://highlightjs.org/) as from 2021-11-24 and github styles in highlight.min.css as from 2021-05-15',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.18.0.2'); // is CKEDITOR Series 4.18.0 - and appended plugin revision .2
    ...
    {
        #$this->temporaryDowngrade('4.18.0.2', '4.18.0.1'); // was temporary used for the harmonization of plugin and lib versions
