...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.11.2.0-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.11.2.0');
     ...
     * @var array
     */
    protected $revisionPackage = array('CKEditor 4.11.2 (revision 7f3189e, full package, 2019-01-11)',
                                       ...
                                       'CKEditor-Plugin: manually added for version "ajax", "autocomplete", "autogrow", "button", "clipboard", "codesnippet", "dialog", "dialogui", "embed", "embedbase", "embedsemantic", "emoji", "fakeobjects", "lineutils", "notification", "notificationaggregator", "placeholder", "textmatch", "textwatcher", "toolbar", "widget", "widgetselection" and "xml" plugins, 2019-01-11)',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.11.2.0'); // is CKEDITOR Series 4.11.2 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.11.2.0', '4.11.1.0'); // was temporary used for the harmonization of plugin and lib versions
