...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.8.0.0-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.8.0.0');
     ...
     * @var array
     */
    protected $revisionPackage = array('CKEditor 4.8.0 (revision 230f715, full package, 2017-12-13)',
                                       ...
                                       'CKEditor-Plugin: manually added autogrow, clipboard, codesnippet, embedbase, embed, embedsemantic, fakeobjects, lineutils, notification, notificationaggregator, widget and widgetselection plugins, 2017-12-29)',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.8.0.0'); // is CKEDITOR Series 4.8.0 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.8.0.0', '4.7.3.2'); // was temporary used for the harmonization of plugin and lib versions
