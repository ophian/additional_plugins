...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.7.3.0-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.7.3.0');
     ...
     * @var array
     */
    protected $revisionPackage = array('CKEditor 4.7.3 (revision dee99e2, full package, 2017-09-25)',
                                       ...
                                       'CKEditor-Plugin: manually added autogrow, clipboard, codesnippet, embedbase, embed, embedsemantic, fakeobjects, lineutils, notification, notificationaggregator, widget and widgetselection plugins, 2017-09-25)',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.7.3.0'); // is CKEDITOR Series 4.7.2 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.7.3.0', '4.7.2.0'); // was temporary used for the harmonization of plugin and lib versions
