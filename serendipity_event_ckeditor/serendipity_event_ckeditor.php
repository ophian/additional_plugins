...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.20.2.0-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.20.2.0');
     ...
     * @var array
     */
    protected $revisionPackage = array('CKEditor 4.20.2 (revision 3a6ef162af, full package, 2023-02-15)',
                                       'CKEditor-Plugin: mediaembed, included to custom build. v. 0.6 (https://github.com/frozeman/MediaEmbed, 2013-07-11)',
                                       'CKEditor-Plugin: Custom build added for current version "ajax", "autocomplete", "autogrow", "autolink", "button", "clipboard", "dialog", "dialogui", "embedbase", "emoji", "fakeobjects", "floatpanel", "lineutils", "notification", "notificationaggregator", "panelbutton", "placeholder", "textmatch", "textwatcher", "undo", "widget", "widgetselection" and "xml" plugins, 2023-02-15)',
                                       'CKEditor-Plugin: Manually added for current version "codesnippet", "embed" and "embedsemantic" plugins, 2023-02-15)',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.20.2.0'); // is CKEDITOR Series 4.20.2 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.20.2.0', '4.20.1.0'); // was temporary used for the harmonization of plugin and lib versions
