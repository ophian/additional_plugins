...
class serendipity_event_ckeditor extends serendipity_event
{
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.14.1.6'); // is CKEDITOR Series 4.14.1 - and appended plugin revision .6
    ...
    {
        #$this->temporaryDowngrade('4.14.1.6', '4.14.1.5'); // was temporary used for the harmonization of plugin and lib versions
