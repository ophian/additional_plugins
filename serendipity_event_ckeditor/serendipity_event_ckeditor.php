...
class serendipity_event_ckeditor extends serendipity_event
{
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.16.1.1'); // is CKEDITOR Series 4.16.1 - and appended plugin revision .1
    ...
    {
        #$this->temporaryDowngrade('4.16.1.1', '4.16.1.0'); // was temporary used for the harmonization of plugin and lib versions
