...
class serendipity_event_ckeditor extends serendipity_event
{
     ...
     * @var string
     */
    protected $cke_zipfile = 'ckeditor_4.19.0.0-plus.zip';
     ...
     * @var array
     */
    protected $checkUpdateVersion = array('ckeditor:4.19.0.0');
    ...
    protected $revisionPackage = array('CKEditor 4.19.0 (revision c08cfedb60, full package, 2022-05-18)',
                                       ...
                                       'CKEditor-S9yAddOn, fresh highlight.min.js file v11.5.1 (https://highlightjs.org/) as from 2022-04-10 and github styles in highlight.min.css as from 2021-05-15',
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.19.0.0'); // is CKEDITOR Series 4.19.0 - and appended plugin revision .0
    ...
    {
        #$this->temporaryDowngrade('4.19.0.0', '4.18.0.2'); // was temporary used for the harmonization of plugin and lib versions
