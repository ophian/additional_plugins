...
class serendipity_event_ckeditor extends serendipity_event
{
    ...
    function introspect(&$propbag)
    {
        ...
        $propbag->add('version',       '4.16.1.4'); // is CKEDITOR Series 4.16.1 - and appended plugin revision .4
    ...
    {
        #$this->temporaryDowngrade('4.16.1.4', '4.16.1.3'); // was temporary used for the harmonization of plugin and lib versions
