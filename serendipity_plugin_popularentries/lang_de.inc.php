...
@define('PLUGIN_POPULARENTRIES_TITLE', 'Beliebte Einträge');
@define('PLUGIN_POPULARENTRIES_BLAHBLAH', 'Zeigt die Titel und die Anzahl der Kommentare zu Einträge mit der höchsten Kommentarzahl, am Meisten oder am Wenigsten besuchte Beiträge');
@define('PLUGIN_POPULARENTRIES_NUMBER', 'Anzahl der Einträge');
@define('PLUGIN_POPULARENTRIES_NUMBER_BLAHBLAH', 'Wieviele Einträge sollen angezeigt werden? (Standard: 10)');
@define('PLUGIN_POPULARENTRIES_NUMBER_FROM', 'Seite auf der Übersicht überspringen');
@define('PLUGIN_POPULARENTRIES_NUMBER_FROM_DESC', 'Nur Beiträge die nicht auf der Startseite dargestellt werden sollen angezeigt werden (Standard: Die letzten ' . $serendipity['fetchLimit'] . ' Beiträge werden übersprungen)');
@define('PLUGIN_POPULARENTRIES_NUMBER_FROM_RADIO_ALL', 'Alle Anzeigen');
