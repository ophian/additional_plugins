...
@define('PLUGIN_BACKUP_DESC', 'Zpøístupòuje možnost automatického zálohování Serendepity - databázových tabulek i souborù. V souèasnosti je podporována pouze databáze MySQL(i). VAROVÁNÍ: Plugin nefunguje optimálnì s velkou databází nebo velkým množstvím souborù.');
...
@define('PLUGIN_BACKUP_AUTO_SQL_BACKUP_STARTED', 'Automatické zálohování SQL databáze spuštìno');
@define('PLUGIN_BACKUP_AUTO_SQL_BACKUP_STOPPED', 'Automatické zálohování SQL databáze zastaveno');
@define('PLUGIN_BACKUP_AUTO_SQL_DELETE_STARTED', 'Automatické mazání SQL databáze spuštìno');
...
@define('PLUGIN_BACKUP_AUTO_HTML_BACKUP_STARTED', 'Automatické zálohování HTML stránek spuštìno');
@define('PLUGIN_BACKUP_AUTO_HTML_BACKUP_STOPPED', 'Automatické zálohování HTML stránek zastaveno');
@define('PLUGIN_BACKUP_AUTO_HTML_DELETE_STARTED', 'Automatické mazání HTML stránek spuštìno');
@define('PLUGIN_BACKUP_AUTO_HTML_DELETE_STOPPED', 'Automatické mazání HTML stránek zastaveno');
@define('PLUGIN_BACKUP_HTML_SAVED', 'Záloha HTML souborù uložena');
