...
@define('PLUGIN_BACKUP_DESC', 'Zpøístupòuje mo¾nost automatického zálohování Serendepity - databázových tabulek i souborù. V souèasnosti je podporována pouze databáze MySQL(i). VAROVÁNÍ: Plugin nefunguje optimálnì s velkou databází nebo velkým mno¾stvím souborù.');
@define('PLUGIN_BACKUP_ABSPATH_BACKUPDIR', 'Absolutní cesta k adresáøi pro zálohy');
@define('PLUGIN_BACKUP_ABSPATH_BACKUPDIR_BLAHBLAH', 'Tento adresáø by mìl být mimo adresáø s webovými stránkami. Webserver musí mít práva zápisu do tohoto adresáøe!');

@define('PLUGIN_BACKUP_NOT_FOUND', 'Záloha nenalezena');
@define('PLUGIN_BACKUP_SQL_RECOVERED', 'Záloha SQL obnovena');
@define('PLUGIN_BACKUP_AUTO_SQL_BACKUP_STARTED', 'Automatické zálohování SQL databáze spu¹tìno');
@define('PLUGIN_BACKUP_AUTO_SQL_BACKUP_STOPPED', 'Automatické zálohování SQL databáze zastaveno');
@define('PLUGIN_BACKUP_AUTO_SQL_DELETE_STARTED', 'Automatické mazání SQL databáze spu¹tìno');
@define('PLUGIN_BACKUP_AUTO_SQL_DELETE_STOPPED', 'Automatické mazání SQL databáze zastaveno');
@define('PLUGIN_BACKUP_SQL_SAVED', 'Záloha SQL databáze ulo¾ena');
@define('PLUGIN_BACKUP_HTML_RECOVERED', 'Záloha HTML obnovena');
@define('PLUGIN_BACKUP_AUTO_HTML_BACKUP_STARTED', 'Automatické zálohování HTML stránek spu¹tìno');
@define('PLUGIN_BACKUP_AUTO_HTML_BACKUP_STOPPED', 'Automatické zálohování HTML stránek zastaveno');
@define('PLUGIN_BACKUP_AUTO_HTML_DELETE_STARTED', 'Automatické mazání HTML stránek spu¹tìno');
@define('PLUGIN_BACKUP_AUTO_HTML_DELETE_STOPPED', 'Automatické mazání HTML stránek zastaveno');
@define('PLUGIN_BACKUP_HTML_SAVED', 'Záloha HTML souborù ulo¾ena');
...
@define('PLUGIN_BACKUP_WITH_DROP_TABLE', 'Vèetnì smazání tabulek (DROP TABLE)');
...
@define('PLUGIN_BACKUP_EVERY', 'ka¾dý');
@define('PLUGIN_BACKUP_MONTHS', 'mìsíce');
...
@define('PLUGIN_BACKUP_OLDER_THAN', 'Zálohy star¹í ne¾');
