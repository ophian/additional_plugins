...
@define('PLUGIN_HTTPAUTH_REMOTEUSER_WILDCARD_DESC', 'This setting is only used when REMOTE_USER Authentication is enabled. If this setting is enabled, an non-existent REMOTE_USER in your s9y database will be authenticated with a hard-coded serendipity author. This means that if a user logs in as "Raymond", but no Serendipity author profile exists, he could be logged in via a central Serendipity accound named "Visitor".');
