...
@define('PLUGIN_EVENT_BLOGPDF_DESC', 'Umožňuje návštěvníkům blogu stáhnout obsah blogu ve formátu PDF');
@define('PLUGIN_EVENT_BLOGPDF_DOWNLOAD', 'Stáhněte tento blog jako PDF!');
...
@define('PLUGIN_EVENT_BLOGPDF_VIEW_ENTRY', 'Tento příspěvek');
