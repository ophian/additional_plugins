        ...
        if (isset($hooks[$event])) {
            ...
            switch($event) {
                ...
                case 'entries_footer':
                    ...
                    if (empty($serendipity['GET']['preview']) && $serendipity['view'] != 'plugin' && (!isset($serendipity['viewtype']) || $serendipity['viewtype'] != '404_4') && (!isset($serendipity['is_staticpage']) || !$serendipity['is_staticpage'])) {
