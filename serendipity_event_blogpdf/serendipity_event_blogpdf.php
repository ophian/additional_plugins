        ...
        if (isset($hooks[$event])) {
            ...
            switch($event) {
                ...
                case 'entries_footer':
                    ...
                    if (empty($serendipity['GET']['preview']) && in_array($serendipity['view'], ['start', 'entries', 'archives', 'entry', 'categories', 'plugin']) && (isset($eventData['id']) || (!isset($serendipity['viewtype']) || $serendipity['viewtype'] != '404_4')) && !isset($serendipity['is_staticpage']) && !isset($eventData['plugin_vars']['tag'])) {
                        // entry views
