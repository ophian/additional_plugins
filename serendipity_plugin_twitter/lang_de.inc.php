...
@define('PLUGIN_EVENT_TWITTER_ANNOUNCE_YOURLSDESC',        '<h3>Yourls Domain und API Signatur</h3><b>yourls</b> Braucht einen eigenen Yourls URL service.<br/>Die Defaults sind nur Platzhalter.<br/><a href="http://yourls.org/" target="_blank" rel="noopener">Hier den yourls URL shortener runterladen und auf Server installieren.</a>.');
