...
@define('PLUGIN_KARMA_VOTETEXT_NAME_BLAHBLAH',		'Text pou¾itý pøi zobrazení pruhu pro hlasování.  (Pøednastaveno: \'' . PLUGIN_KARMA_VOTETEXT . '\')');
@define('PLUGIN_KARMA_RATE',		'Ohodno» tento èlánek: %s');
@define('PLUGIN_KARMA_VOTEPOINT_5',		'Dost dobrý!');
@define('PLUGIN_KARMA_VOTEPOINT_5_NAME',		'Popis pro nejlep¹í hodnocení');
@define('PLUGIN_KARMA_VOTEPOINT_5_BLAHBLAH',		'Slovní varianta pro nejlep¹í mo¾né hodnocení. (Pøednastaveno: \'' . PLUGIN_KARMA_VOTEPOINT_5 . '\')');
...
@define('PLUGIN_KARMA_VOTEPOINT_1_NAME',		'Popis pro nejhor¹í hodnocení');
@define('PLUGIN_KARMA_VOTEPOINT_1_BLAHBLAH',		'Slovní varianta pro nejhor¹í hodnocení. (Pøednastaveno: \'' . PLUGIN_KARMA_VOTEPOINT_1 . '\')');
@define('PLUGIN_KARMA_VOTETEXT_5',		'+2');
@define('PLUGIN_KARMA_VOTETEXT_5_NAME',		'Hodnota nejlep¹ího hodnocení');
@define('PLUGIN_KARMA_VOTETEXT_5_BLAHBLAH',		'Text, který se zobrazí jako hodnota nejlep¹ího hodnocení v hodnotícím pruhu. (Pøednastaveno: ' . PLUGIN_KARMA_VOTETEXT_5 . ')');
@define('PLUGIN_KARMA_VOTETEXT_4',		'+1');
@define('PLUGIN_KARMA_VOTETEXT_4_NAME',		'Hodnota dobrého hodnocení');
@define('PLUGIN_KARMA_VOTETEXT_4_BLAHBLAH',		'Text, který se zobrazí jako hodnota dobrého hodnocení v hodnotícím pruhu. (Pøednastaveno: ' . PLUGIN_KARMA_VOTETEXT_4 . ')');
@define('PLUGIN_KARMA_VOTETEXT_3',		'0');
@define('PLUGIN_KARMA_VOTETEXT_3_NAME',		'Hodnota neutrálního hodnocení');
@define('PLUGIN_KARMA_VOTETEXT_3_BLAHBLAH',		'Text, který se zobrazí jako hodnota neutrálního hodnocení v hodnotícím pruhu. (Pøednastaveno: ' . PLUGIN_KARMA_VOTETEXT_3 . ')');
@define('PLUGIN_KARMA_VOTETEXT_2',		'-1');
@define('PLUGIN_KARMA_VOTETEXT_2_NAME',		'Hodnota slabého hodnocení');
@define('PLUGIN_KARMA_VOTETEXT_2_BLAHBLAH',		'Text, který se zobrazí jako hodnota slabého hodnocení v hodnotícím pruhu. (Pøednastaveno: ' . PLUGIN_KARMA_VOTETEXT_2 . ')');
@define('PLUGIN_KARMA_VOTETEXT_1',		'-2');
@define('PLUGIN_KARMA_VOTETEXT_1_NAME',		'Hodnota nejhor¹ího hodnocení');
@define('PLUGIN_KARMA_VOTETEXT_1_BLAHBLAH',		'Text, který se zobrazí jako hodnota nejhor¹ího hodnocení v hodnotícím pruhu. (Pøednastaveno: ' . PLUGIN_KARMA_VOTETEXT_1 . ')');
...
@define('PLUGIN_KARMA_NOCOOKIE',		'Vá¹ prohlí¾eè musí podporovat cookies. jinak nemù¾ete hlasovat.');
@define('PLUGIN_KARMA_CLOSED',		'Hodnocení èlánku novìj¹í ne¾ %s dní!');
...
@define('PLUGIN_KARMA_TIMEOUT',		'Ochrana proti zahlcením serveru: Jiný ètenáø právì hlasoval. Poèkejte pøed Va¹ím hlasování %s minut, prosím.');
@define('PLUGIN_KARMA_CURRENT',		'Souèasná karma: %2$s, %3$s hlas(ù)');
@define('PLUGIN_KARMA_CURRENT_NAME',		'Zpráva souèasného hodnocení');
@define('PLUGIN_KARMA_CURRENT_NAME_BLAHBLAH',		'Text pou¾itý pro zobrazení souèasného hodnocení (%2$s je èíselné hodnocení; %3$s je poèet hlasù) (Pøednastaveno: ' . PLUGIN_KARMA_CURRENT . ')');
@define('PLUGIN_KARMA_EXTENDEDONLY',		'Pouze kompletní èlánek');
@define('PLUGIN_KARMA_EXTENDEDONLY_BLAHBLAH',		'Zobrazovat karma-hodnocení pouze pøi zobrazení celého èlánku = pøi zobrazení roz¹íøené textové èásti.');
@define('PLUGIN_KARMA_MAXKARMA',		'Období pro karmu');
@define('PLUGIN_KARMA_MAXKARMA_BLAHBLAH',		'Povolit hlsování karmy pro èlánek, který je mlad¹í ne¾ X dní (Standardnì: 7)');
...
@define('PLUGIN_KARMA_VISITS',		'Povolit sledování náv¹tìv?');
@define('PLUGIN_KARMA_VISITS_BLAHBLAH',		'Má být ka¾dé klinkutí na zobrazení roz¹íøené textové èásti poèítáno a zaznamenáváno?');
@define('PLUGIN_KARMA_VISITSCOUNT',		' %4$s zobrazení');
@define('PLUGIN_KARMA_STATISTICS_VISITS_TOP',		'Neètenìj¹í pøíspìvky');
...
@define('PLUGIN_KARMA_STATISTICS_POINTS_TOP',		'Pøíspìvky s nejlep¹í karmou');
@define('PLUGIN_KARMA_STATISTICS_POINTS_BOTTOM',		'Pøíspìvky s nejhor¹í karmou');
...
@define('PLUGIN_KARMA_VISITS_LOGGEDIN_USERS',		'Sledovat náv¹tìvy pøihlá¹ených u¾ivatelù?');
@define('PLUGIN_KARMA_VISITS_LOGGEDIN_USERS_BLAHBLAH',		'Pokud je tato volba povolena, náv¹tìvy u¾ivatelù, kteøí jsou pøihlá¹eni, jsou také zaznamenávány. (Takovými u¾iateli jste napøíklad vy pøi zadávání nových pøípìvkù a jejich odlaïování)');
@define('PLUGIN_KARMA_MIN_DISPLAYABLE_VISITS',		'Minimální poèet náv¹tìv pro zobrazení');
@define('PLUGIN_KARMA_MIN_DISPLAYABLE_VISITS_BLAHBLAH',		'Poèet náv¹tìv bude zobrazován pouze pokud jejich poèet pøekroèí zde uvedenou hodnotu. Chcete-li poèítadlo zobrazovat v¾dy, zadejte 0.');
...
@define('PLUGIN_KARMA_IMAGE_WITH_VISITS_BLAHBLAH',		'Vlo¾it poèet náv¹tìv i jako text? (za pruhy, nemá na pruhy ¾ádný efekt) (Pøednastaveno: ano)');
@define('PLUGIN_KARMA_PREVIEW_BG',		'Pozadí pro tabulku náhledu, ní¾e');
@define('PLUGIN_KARMA_PREVIEW_BG_BLAHBLAH',		'Platná je jakákoliv hodnota CSS stylù; bude pou¾ita jako atribut \'background\' pro tabulku s náhledem, a to POUZE na administrativní stránce. Nemá ¾ádný efekt na pruhy s hodnocením.');
...
@define('PLUGIN_KARMA_IMAGE_NONE_RATING',		'¾ádný');
