...
@define('PLUGIN_EVENT_FACEBOOK_DESC', 'Importuje do blogu komentáøe u pøíspìvkù na facebooku (pomocí RSS Graffiti). Také do blogu vloí facebookové OpenGraph Meta-Tagy. Pamatujte, e pøidání talèítka "Líbí se mi" k pøíspìvkùm blogu je zajišováno pluginem serendipity_event_social!');
