...
@define('PLUGIN_EVENT_TODOLIST_WHITETEXTBORDER', 'Weiße Farbe des Textrahmens');
...
@define('PLUGIN_EVENT_TODOLIST_DEFAULT_NOTE', 'Bitte beachten Sie, dass dies ein Ereignis/Event-Plugin ist und Sie daher entweder das Event-Ausgabe Seitenleisten-Plugin verwenden sollten, um die Ausgaben in der Seitenleiste darzustellen, oder das individuelle Linkverwaltungs-Seitenleisten Plugin installieren müssen.');
...
@define('PLUGIN_EVENT_TODOLIST_CATBARLENGTH', 'Länge des Fortschrittbalkens (Kateg. Sortierung');
