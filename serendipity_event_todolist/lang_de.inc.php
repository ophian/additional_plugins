...
@define('PLUGIN_EVENT_TODOLIST_DEFAULT_NOTE','Bitte beachten dass dies ein Ereignis/Event-Plugin ist und Sie daher das Event-Ausgabe Seitenleisten-Plugin verwenden müssen, um die Ausgaben in der Seiteleiste darzustellen.');
