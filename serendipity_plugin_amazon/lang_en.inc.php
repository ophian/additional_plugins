...
@define('PLUGIN_AMAZON_DEPENDS_ON', 'This plugin now depends on the <a href="https://ophian.github.io/plugins/#group_BACKEND_EDITOR" >Amazon Media Button</a> event plugin. Please install the plugin and configure it to connect to Amazon.');
