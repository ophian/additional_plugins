                ...
                case 'frontend_display':
                    ...
                    foreach ($this->markup_elements AS $temp) {
                        ...
                        &&  !isset($serendipity['POST']['properties']['disable_markup_' . $this->instance])) {
                            ...
                            if ($element != 'comment' && false !== strpos($source, '<sup class="wikiref">')) {
...
//does not work                        'img_url'    => 'data:image/svg+xml,<svg viewBox=\'0 0 16 16\' fill=\'currentColor\' xmlns=\'http://www.w3.org/2000/svg\'><path d=\'M2 2.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5V3a.5.5 0 0 0-.5-.5zM3 3H2v1h1z\'/><path d=\'M5 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M5.5 7a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1zm0 4a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1z\'/><path d=\'M1.5 7a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5zM2 7h1v1H2zm0 3.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm1 .5H2v1h1z\'/></svg>',
                        'img_url'    => $serendipity['serendipityHTTPPath'] . 'plugins/serendipity_event_wikilinks/create_staticpage.png',
// no need when we have css_backend hook. Else use this
               ...
               case 'external_plugin':
                    ...
                    switch($uri_part) {
                        case 'wikilinks':
                            #$this->show(htmlspecialchars($_GET['txtarea']), str_replace('serendipity_textarea_', '', htmlspecialchars($_GET['txtarea']))); // needs to be for Styx 5
                            $this->show(htmlspecialchars($_GET['txtarea']), preg_replace('/serendipity\[(.*?)\]/', '$1', htmlspecialchars($_GET['txtarea'])));
                            break;
                    }
                    break;
    ...
    function _reference($buffer)
    {
        ...
        $result = str_replace(
            ...
            array(
                $refix,
                (function_exists('serendipity_specialchars') ? serendipity_specialchars(strip_tags($buffer['ref'] ?? '')) : htmlspecialchars(strip_tags($buffer['ref'] ?? ''), ENT_COMPAT, LANG_CHARSET)),// strips link out of title attribute
